/* tracker-array-cursor.c generated by valac 0.12.0.69-6c49, the Vala compiler
...
TrackerBusArrayCursor* tracker_bus_array_cursor_construct (GType object_type, gchar** results, int results_length1, int results_length2, gint rows, gint cols, gchar** var_names, int var_names_length1, TrackerSparqlValueType* types, int types_length1) {
	...
	_tmp1_ = (_tmp2_ = types, (_tmp2_ == NULL) ? ((gpointer) _tmp2_) : _vala_array_dup2 (_tmp2_, types_length1));
	self->priv->types = (g_free (self->priv->types), NULL);
	self->priv->types = _tmp1_;
	self->priv->types_length1 = types_length1;
	self->priv->_types_size_ = types_length1;
	_tmp3_ = (_tmp4_ = var_names, (_tmp4_ == NULL) ? ((gpointer) _tmp4_) : _vala_array_dup3 (_tmp4_, var_names_length1));
	self->priv->var_names = (_vala_array_free (self->priv->var_names, self->priv->var_names_length1, (GDestroyNotify) g_free), NULL);
	self->priv->var_names = _tmp3_;
	self->priv->var_names_length1 = var_names_length1;
	self->priv->_var_names_size_ = var_names_length1;
