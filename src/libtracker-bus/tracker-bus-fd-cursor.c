/* tracker-bus-fd-cursor.c generated by valac 0.14.0, the Vala compiler
...
static gchar** _vala_array_dup4 (gchar** self, int length) {
	gchar** result;
	int i;
#line 34 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
TrackerBusFDCursor* tracker_bus_fd_cursor_construct (GType object_type, gchar* buffer, gulong buffer_size, gchar** variable_names, int variable_names_length1) {
	...
	gchar** _tmp4_;
	gint _tmp4__length1;
#line 31 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self = (TrackerBusFDCursor*) tracker_sparql_cursor_construct (object_type);
#line 32 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp0_ = buffer;
#line 32 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self->buffer = _tmp0_;
#line 33 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp1_ = buffer_size;
#line 33 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
#line 35 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
static inline gint tracker_bus_fd_cursor_buffer_read_int (TrackerBusFDCursor* self) {
	...
	gint v;
	gulong _tmp2_;
#line 42 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	g_return_val_if_fail (self != NULL, 0);
#line 43 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp0_ = self->buffer;
#line 43 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp1_ = self->buffer_index;
#line 43 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	v = *((gint*) (_tmp0_ + _tmp1_));
#line 45 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp2_ = self->buffer_index;
#line 45 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self->buffer_index = _tmp2_ + 4;
#line 47 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	result = v;
#line 47 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	return result;
...
static TrackerSparqlValueType tracker_bus_fd_cursor_real_get_value_type (TrackerSparqlCursor* base, gint column) {
	...
	gint _tmp2_;
	gint _tmp3_;
#line 54 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self = (TrackerBusFDCursor*) base;
#line 54 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp0_ = self->types;
#line 54 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	g_return_val_if_fail (_tmp0_ != NULL, 0);
#line 57 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp1_ = self->types;
#line 57 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp2_ = column;
#line 57 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
static const gchar* tracker_bus_fd_cursor_real_get_variable_name (TrackerSparqlCursor* base, gint column) {
	...
	gint _tmp2_;
	const gchar* _tmp3_;
#line 60 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self = (TrackerBusFDCursor*) base;
#line 60 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
#line 62 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
static const gchar* tracker_bus_fd_cursor_real_get_string (TrackerSparqlCursor* base, gint column, glong* length) {
	...
	gint _tmp15_;
	const gchar* _tmp16_;
#line 65 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self = (TrackerBusFDCursor*) base;
#line 65 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp0_ = column;
#line 65 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
#line 67 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	str = NULL;
#line 70 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp4_ = self->types;
#line 70 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp5_ = column;
#line 70 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
#line 71 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
		_vala_length = (glong) 0;
#line 72 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
		result = NULL;
#line 72 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
		if (length) {
#line 72 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
#line 75 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp7_ = column;
#line 75 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	if (_tmp7_ == 0) {
#line 323 "tracker-bus-fd-cursor.c"
		gchar* _tmp8_;
#line 76 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
		_tmp8_ = self->data;
#line 76 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
#line 329 "tracker-bus-fd-cursor.c"
		...
		gint _tmp11_;
		gint _tmp12_;
#line 78 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
		_tmp9_ = self->data;
#line 78 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
#line 81 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp13_ = str;
#line 81 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
#line 83 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp16_ = str;
#line 83 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	result = _tmp16_;
#line 83 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
static gboolean tracker_bus_fd_cursor_real_next (TrackerSparqlCursor* base, GCancellable* cancellable, GError** error) {
	...
	gulong _tmp16_;
	gint _tmp17_;
#line 86 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self = (TrackerBusFDCursor*) base;
#line 89 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp0_ = self->buffer_index;
#line 89 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp1_ = self->buffer_size;
#line 89 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	if (_tmp0_ >= _tmp1_) {
#line 90 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
		result = FALSE;
#line 90 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
		return result;
#line 405 "tracker-bus-fd-cursor.c"
	}
#line 100 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp2_ = tracker_bus_fd_cursor_buffer_read_int (self);
#line 100 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self->_n_columns = _tmp2_;
#line 104 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp3_ = self->buffer;
#line 104 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp4_ = self->buffer_index;
#line 104 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self->types = (gint*) (_tmp3_ + _tmp4_);
#line 105 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
#line 107 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp8_ = self->buffer;
#line 107 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp9_ = self->buffer_index;
#line 107 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self->offsets = (gint*) (_tmp8_ + _tmp9_);
#line 108 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
#line 109 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp13_ = tracker_bus_fd_cursor_buffer_read_int (self);
#line 109 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	last_offset = _tmp13_;
#line 111 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp14_ = self->buffer;
#line 111 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp15_ = self->buffer_index;
#line 111 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self->data = _tmp14_ + _tmp15_;
#line 113 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp16_ = self->buffer_index;
#line 113 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp17_ = last_offset;
#line 113 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self->buffer_index = _tmp16_ + (_tmp17_ + 1);
#line 115 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	result = TRUE;
#line 115 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	return result;
...
static void tracker_bus_fd_cursor_real_next_async_data_free (gpointer _data) {
	...
	_data_ = _data;
#line 20 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
static gboolean tracker_bus_fd_cursor_real_next_async_co (TrackerBusFdCursorNextAsyncData* _data_) {
#line 118 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
#line 542 "tracker-bus-fd-cursor.c"
	...
	_state_0:
#line 120 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
static void tracker_bus_fd_cursor_real_rewind (TrackerSparqlCursor* base) {
	TrackerBusFDCursor * self;
	gchar* _tmp0_;
#line 123 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self = (TrackerBusFDCursor*) base;
#line 124 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self->buffer_index = (gulong) 0;
#line 125 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp0_ = self->buffer;
#line 125 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self->data = _tmp0_;
...
static gint tracker_bus_fd_cursor_real_get_n_columns (TrackerSparqlCursor* base) {
	...
	TrackerBusFDCursor* self;
	gint _tmp0_;
#line 51 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self = (TrackerBusFDCursor*) base;
#line 51 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
...
#line 39 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	_tmp0_ = self->buffer;
#line 39 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	g_free (_tmp0_);
#line 29 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
	self->variable_names = (_vala_array_free (self->variable_names, self->variable_names_length1, (GDestroyNotify) g_free), NULL);
#line 20 "/home/juerg/Code/tracker/tracker/src/libtracker-bus/tracker-bus-fd-cursor.vala"
