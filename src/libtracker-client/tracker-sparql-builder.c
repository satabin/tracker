/* tracker-sparql-builder.c generated by valac 0.9.5.4-19a5, the Vala compiler
...
void tracker_sparql_builder_object_int64 (TrackerSparqlBuilder* self, gint64 literal) {
	char* _tmp0_;
	g_return_if_fail (self != NULL);
	tracker_sparql_builder_object (self, _tmp0_ = g_strdup_printf ("%" G_GINT64_FORMAT, literal));
	_g_free0 (_tmp0_);
}
