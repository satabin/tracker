/* tracker-sparql-scanner.c generated by valac 0.11.5, the Vala compiler
	...
	switch (len) {
			...
			switch (begin[0]) {
					...
					switch (begin[1]) {
						...
						case 's':
						{
							switch (begin[2]) {
								...
								{
									gboolean _tmp4_;
									_tmp4_ = tracker_sparql_scanner_matches (self, begin, "ASC");
									if (_tmp4_) {
								...
								{
									gboolean _tmp5_;
									_tmp5_ = tracker_sparql_scanner_matches (self, begin, "ASK");
									if (_tmp5_) {
						...
						{
							gboolean _tmp6_;
							_tmp6_ = tracker_sparql_scanner_matches (self, begin, "AVG");
							if (_tmp6_) {
				...
				case 'm':
				{
					switch (begin[1]) {
						...
						{
							gboolean _tmp7_;
							_tmp7_ = tracker_sparql_scanner_matches (self, begin, "MAX");
							if (_tmp7_) {
						...
						{
							gboolean _tmp8_;
							_tmp8_ = tracker_sparql_scanner_matches (self, begin, "MIN");
							if (_tmp8_) {
				...
				{
					gboolean _tmp9_;
					_tmp9_ = tracker_sparql_scanner_matches (self, begin, "NOT");
					if (_tmp9_) {
				...
				case 's':
				{
					switch (begin[1]) {
						...
						{
							gboolean _tmp10_;
							_tmp10_ = tracker_sparql_scanner_matches (self, begin, "STR");
							if (_tmp10_) {
						...
						{
							gboolean _tmp11_;
							_tmp11_ = tracker_sparql_scanner_matches (self, begin, "SUM");
							if (_tmp11_) {
		...
		case 4:
		{
			switch (begin[0]) {
				...
				{
					gboolean _tmp12_;
					_tmp12_ = tracker_sparql_scanner_matches (self, begin, "BASE");
					if (_tmp12_) {
				...
				case 'd':
				{
					switch (begin[1]) {
						...
						{
							gboolean _tmp13_;
							_tmp13_ = tracker_sparql_scanner_matches (self, begin, "DATA");
							if (_tmp13_) {
						...
						{
							gboolean _tmp14_;
							_tmp14_ = tracker_sparql_scanner_matches (self, begin, "DESC");
							if (_tmp14_) {
						...
						{
							gboolean _tmp15_;
							_tmp15_ = tracker_sparql_scanner_matches (self, begin, "DROP");
							if (_tmp15_) {
				...
				{
					gboolean _tmp16_;
					_tmp16_ = tracker_sparql_scanner_matches (self, begin, "FROM");
					if (_tmp16_) {
				...
				{
					gboolean _tmp17_;
					_tmp17_ = tracker_sparql_scanner_matches (self, begin, "INTO");
					if (_tmp17_) {
				...
				{
					gboolean _tmp18_;
					_tmp18_ = tracker_sparql_scanner_matches (self, begin, "LANG");
					if (_tmp18_) {
				...
				{
					gboolean _tmp19_;
					_tmp19_ = tracker_sparql_scanner_matches (self, begin, "TRUE");
					if (_tmp19_) {
				...
				{
					gboolean _tmp20_;
					_tmp20_ = tracker_sparql_scanner_matches (self, begin, "WITH");
					if (_tmp20_) {
		...
		case 5:
		{
			switch (begin[0]) {
				...
				{
					gboolean _tmp21_;
					_tmp21_ = tracker_sparql_scanner_matches (self, begin, "BOUND");
					if (_tmp21_) {
				...
				{
					gboolean _tmp22_;
					_tmp22_ = tracker_sparql_scanner_matches (self, begin, "COUNT");
					if (_tmp22_) {
				...
				case 'g':
				{
					switch (begin[2]) {
						...
						{
							gboolean _tmp23_;
							_tmp23_ = tracker_sparql_scanner_matches (self, begin, "GRAPH");
							if (_tmp23_) {
						...
						{
							gboolean _tmp24_;
							_tmp24_ = tracker_sparql_scanner_matches (self, begin, "GROUP");
							if (_tmp24_) {
				...
				{
					gboolean _tmp25_;
					_tmp25_ = tracker_sparql_scanner_matches (self, begin, "LIMIT");
					if (_tmp25_) {
				...
				{
					gboolean _tmp26_;
					_tmp26_ = tracker_sparql_scanner_matches (self, begin, "NAMED");
					if (_tmp26_) {
				...
				{
					gboolean _tmp27_;
					_tmp27_ = tracker_sparql_scanner_matches (self, begin, "ORDER");
					if (_tmp27_) {
				...
				{
					gboolean _tmp28_;
					_tmp28_ = tracker_sparql_scanner_matches (self, begin, "REGEX");
					if (_tmp28_) {
				...
				{
					gboolean _tmp29_;
					_tmp29_ = tracker_sparql_scanner_matches (self, begin, "UNION");
					if (_tmp29_) {
				...
				{
					gboolean _tmp30_;
					_tmp30_ = tracker_sparql_scanner_matches (self, begin, "WHERE");
					if (_tmp30_) {
				...
				{
					gboolean _tmp31_;
					_tmp31_ = tracker_sparql_scanner_matches (self, begin, "FALSE");
					if (_tmp31_) {
					...
					switch (begin[1]) {
						...
						case 's':
						{
							switch (begin[2]) {
								...
								{
									gboolean _tmp32_;
									_tmp32_ = tracker_sparql_scanner_matches (self, begin, "ISIRI");
									if (_tmp32_) {
								...
								{
									gboolean _tmp33_;
									_tmp33_ = tracker_sparql_scanner_matches (self, begin, "ISURI");
									if (_tmp33_) {
		...
		case 6:
		{
			switch (begin[0]) {
				...
				{
					gboolean _tmp34_;
					_tmp34_ = tracker_sparql_scanner_matches (self, begin, "DELETE");
					if (_tmp34_) {
				...
				{
					gboolean _tmp35_;
					_tmp35_ = tracker_sparql_scanner_matches (self, begin, "EXISTS");
					if (_tmp35_) {
				...
				{
					gboolean _tmp36_;
					_tmp36_ = tracker_sparql_scanner_matches (self, begin, "FILTER");
					if (_tmp36_) {
				...
				{
					gboolean _tmp37_;
					_tmp37_ = tracker_sparql_scanner_matches (self, begin, "INSERT");
					if (_tmp37_) {
				...
				{
					gboolean _tmp38_;
					_tmp38_ = tracker_sparql_scanner_matches (self, begin, "OFFSET");
					if (_tmp38_) {
				...
				{
					gboolean _tmp39_;
					_tmp39_ = tracker_sparql_scanner_matches (self, begin, "PREFIX");
					if (_tmp39_) {
				...
				case 's':
				{
					switch (begin[1]) {
						...
						{
							gboolean _tmp40_;
							_tmp40_ = tracker_sparql_scanner_matches (self, begin, "SELECT");
							if (_tmp40_) {
						...
						{
							gboolean _tmp41_;
							_tmp41_ = tracker_sparql_scanner_matches (self, begin, "SILENT");
							if (_tmp41_) {
		...
		case 7:
		{
			switch (begin[0]) {
				...
				{
					gboolean _tmp42_;
					_tmp42_ = tracker_sparql_scanner_matches (self, begin, "REDUCED");
					if (_tmp42_) {
				...
				{
					gboolean _tmp43_;
					_tmp43_ = tracker_sparql_scanner_matches (self, begin, "ISBLANK");
					if (_tmp43_) {
			...
			switch (begin[0]) {
				...
				case 'd':
				{
					switch (begin[1]) {
						...
						{
							gboolean _tmp44_;
							_tmp44_ = tracker_sparql_scanner_matches (self, begin, "DATATYPE");
							if (_tmp44_) {
						...
						{
							gboolean _tmp45_;
							_tmp45_ = tracker_sparql_scanner_matches (self, begin, "DESCRIBE");
							if (_tmp45_) {
						...
						{
							gboolean _tmp46_;
							_tmp46_ = tracker_sparql_scanner_matches (self, begin, "DISTINCT");
							if (_tmp46_) {
				...
				{
					gboolean _tmp47_;
					_tmp47_ = tracker_sparql_scanner_matches (self, begin, "OPTIONAL");
					if (_tmp47_) {
				...
				{
					gboolean _tmp48_;
					_tmp48_ = tracker_sparql_scanner_matches (self, begin, "SAMETERM");
					if (_tmp48_) {
		...
		case 9:
		{
			switch (begin[0]) {
				...
				{
					gboolean _tmp49_;
					_tmp49_ = tracker_sparql_scanner_matches (self, begin, "CONSTRUCT");
					if (_tmp49_) {
				...
				{
					gboolean _tmp50_;
					_tmp50_ = tracker_sparql_scanner_matches (self, begin, "ISLITERAL");
					if (_tmp50_) {
		...
		{
			gboolean _tmp51_;
			_tmp51_ = tracker_sparql_scanner_matches (self, begin, "LANGMATCHES");
			if (_tmp51_) {
		...
		{
			gboolean _tmp52_;
			_tmp52_ = tracker_sparql_scanner_matches (self, begin, "GROUP_CONCAT");
			if (_tmp52_) {
