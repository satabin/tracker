/* tracker-direct.c generated by valac 0.12.0.69-6c49, the Vala compiler
...
static gboolean tracker_direct_connection_real_query_async_co (TrackerDirectConnectionQueryAsyncData* data) {
	...
	if (!data->_tmp0_) {
		...
		data->_tmp1_ = NULL;
		data->_tmp1_ = g_main_context_get_thread_default ();
		data->_tmp2_ = _g_main_context_ref0 (data->_tmp1_);
		data->_data2_->context = data->_tmp2_;
		...
		if (data->_data2_->sparql_error != NULL) {
			data->_tmp3_ = _g_error_copy0 (data->_data2_->sparql_error);
			...
			if (data->_data2_->io_error != NULL) {
				data->_tmp4_ = _g_error_copy0 (data->_data2_->io_error);
				...
				if (data->_data2_->dbus_error != NULL) {
					data->_tmp5_ = _g_error_copy0 (data->_data2_->dbus_error);
					...
					data->_tmp6_ = _g_object_ref0 (data->_data2_->_result_);
	...
	data->_tmp7_ = NULL;
	data->_tmp7_ = tracker_direct_connection_query_unlocked (data->self, data->_data1_->sparql, data->_data1_->cancellable, &data->_inner_error_);
