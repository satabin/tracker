...
void
tracker_marshal_VOID__OBJECT_BOOLEAN (GClosure     *closure,
...
tracker_marshal_VOID__OBJECT_OBJECT_BOOLEAN_BOOLEAN (GClosure     *closure,
                                                     ...
                                                     gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__OBJECT_OBJECT_BOOLEAN_BOOLEAN) (gpointer     data1,
                                                                    gpointer     arg_1,
                                                                    gpointer     arg_2,
                                                                    gboolean     arg_3,
                                                                    gboolean     arg_4,
                                                                    gpointer     data2);
  register GMarshalFunc_VOID__OBJECT_OBJECT_BOOLEAN_BOOLEAN callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__OBJECT_OBJECT_BOOLEAN_BOOLEAN) (marshal_data ? marshal_data : cc->callback);
...
tracker_marshal_VOID__OBJECT_POINTER_UINT_UINT_UINT_UINT (GClosure     *closure,
                                                          ...
                                                          gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__OBJECT_POINTER_UINT_UINT_UINT_UINT) (gpointer     data1,
                                                                         gpointer     arg_1,
                                                                         gpointer     arg_2,
                                                                         guint        arg_3,
                                                                         guint        arg_4,
                                                                         ...
                                                                         guint        arg_6,
                                                                         gpointer     data2);
  register GMarshalFunc_VOID__OBJECT_POINTER_UINT_UINT_UINT_UINT callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__OBJECT_POINTER_UINT_UINT_UINT_UINT) (marshal_data ? marshal_data : cc->callback);
...
tracker_marshal_VOID__DOUBLE_UINT_UINT_UINT_UINT (GClosure     *closure,
                                                  ...
                                                  gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__DOUBLE_UINT_UINT_UINT_UINT) (gpointer     data1,
                                                                 gdouble      arg_1,
                                                                 guint        arg_2,
                                                                 guint        arg_3,
                                                                 guint        arg_4,
                                                                 guint        arg_5,
                                                                 gpointer     data2);
  register GMarshalFunc_VOID__DOUBLE_UINT_UINT_UINT_UINT callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__DOUBLE_UINT_UINT_UINT_UINT) (marshal_data ? marshal_data : cc->callback);
...
tracker_marshal_VOID__STRING_DOUBLE_INT (GClosure     *closure,
                                         ...
                                         gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__STRING_DOUBLE_INT) (gpointer     data1,
                                                        gpointer     arg_1,
                                                        gdouble      arg_2,
                                                        gint         arg_3,
                                                        gpointer     data2);
  register GMarshalFunc_VOID__STRING_DOUBLE_INT callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__STRING_DOUBLE_INT) (marshal_data ? marshal_data : cc->callback);
...
tracker_marshal_VOID__STRING_STRING_DOUBLE_INT (GClosure     *closure,
                                                ...
                                                gpointer      marshal_data)
{
  typedef void (*GMarshalFunc_VOID__STRING_STRING_DOUBLE_INT) (gpointer     data1,
                                                               gpointer     arg_1,
                                                               gpointer     arg_2,
                                                               gdouble      arg_3,
                                                               gint         arg_4,
                                                               gpointer     data2);
  register GMarshalFunc_VOID__STRING_STRING_DOUBLE_INT callback;
  register GCClosure *cc = (GCClosure*) closure;
  register gpointer data1, data2;
  ...
  callback = (GMarshalFunc_VOID__STRING_STRING_DOUBLE_INT) (marshal_data ? marshal_data : cc->callback);
