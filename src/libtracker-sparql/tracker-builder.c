/* tracker-builder.c generated by valac 0.22.1, the Vala compiler
 ...
 */
static void _vala_array_add13 (TrackerSparqlBuilderState** array, int* length, int* size, TrackerSparqlBuilderState value) {
#line 513 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	if ((*length) == (*size)) {
#line 513 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 513 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
...
#line 1621 "tracker-builder.c"
	} else {
#line 1169 "/usr/share/vala-0.22/vapi/glib-2.0.vapi"
		_tmp0_ = FALSE;
#line 1625 "tracker-builder.c"
	}
#line 1169 "/usr/share/vala-0.22/vapi/glib-2.0.vapi"
	_tmp3_ = _tmp0_;
#line 1169 "/usr/share/vala-0.22/vapi/glib-2.0.vapi"
	if (_tmp3_) {
#line 1631 "tracker-builder.c"
		glong _tmp4_ = 0L;
		glong _tmp5_ = 0L;
		glong _tmp6_ = 0L;
...
#line 1683 "tracker-builder.c"
	}
#line 1182 "/usr/share/vala-0.22/vapi/glib-2.0.vapi"
	_tmp15_ = len;
#line 1182 "/usr/share/vala-0.22/vapi/glib-2.0.vapi"
	if (_tmp15_ < ((glong) 0)) {
#line 1689 "tracker-builder.c"
		glong _tmp16_ = 0L;
		glong _tmp17_ = 0L;
...
#line 552 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	g_return_if_fail (self != NULL);
#line 553 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	_tmp1_ = literal;
#line 553 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	if (_tmp1_) {
#line 553 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
...
void tracker_sparql_builder_object_int64 (TrackerSparqlBuilder* self, gint64 literal) {
	...
	gchar* _tmp1_ = NULL;
	gchar* _tmp2_ = NULL;
#line 565 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	g_return_if_fail (self != NULL);
#line 566 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	_tmp0_ = literal;
#line 566 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
...
static void g_time_gm (time_t time, struct tm* result) {
	...
	struct tm _tmp0_ = {0};
#line 2435 "/usr/share/vala-0.22/vapi/glib-2.0.vapi"
	gmtime_r (&time, &_tmp0_);
#line 2435 "/usr/share/vala-0.22/vapi/glib-2.0.vapi"
	_result_ = _tmp0_;
#line 2436 "/usr/share/vala-0.22/vapi/glib-2.0.vapi"
	*result = _result_;
#line 2436 "/usr/share/vala-0.22/vapi/glib-2.0.vapi"
	return;
...
void tracker_sparql_builder_object_date (TrackerSparqlBuilder* self, time_t* literal) {
	...
	gchar* _tmp14_ = NULL;
	gchar* _tmp15_ = NULL;
#line 579 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	g_return_if_fail (self != NULL);
...
static gchar* double_to_string (gdouble self) {
	...
	gchar* _tmp3_ = NULL;
	gchar* _tmp4_ = NULL;
#line 781 "/usr/share/vala-0.22/vapi/glib-2.0.vapi"
...
void tracker_sparql_builder_object_double (TrackerSparqlBuilder* self, gdouble literal) {
	...
	gchar* _tmp1_ = NULL;
	gchar* _tmp2_ = NULL;
#line 594 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	g_return_if_fail (self != NULL);
 ...
 */
static void _vala_array_add14 (TrackerSparqlBuilderState** array, int* length, int* size, TrackerSparqlBuilderState value) {
#line 616 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	if ((*length) == (*size)) {
#line 616 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 616 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
...
#line 608 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	g_return_if_fail ((_tmp1_ == TRACKER_SPARQL_BUILDER_STATE_PREDICATE) || (_tmp3_ == TRACKER_SPARQL_BUILDER_STATE_OBJECT));
#line 611 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	_tmp4_ = tracker_sparql_builder_get_state (self);
#line 611 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	_tmp5_ = _tmp4_;
#line 611 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
...
#line 612 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
		g_string_append (_tmp6_, " ,");
#line 613 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
		_tmp7_ = self->priv->states_length1;
#line 613 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
		self->priv->states_length1 = _tmp7_ - 1;
#line 2061 "tracker-builder.c"
	}
#line 615 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	_tmp8_ = self->priv->str;
#line 615 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	g_string_append (_tmp8_, " [");
#line 616 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
 ...
 */
static void _vala_array_add15 (TrackerSparqlBuilderState** array, int* length, int* size, TrackerSparqlBuilderState value) {
#line 632 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	if ((*length) == (*size)) {
#line 632 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 632 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
		*array = g_renew (TrackerSparqlBuilderState, *array, *size);
#line 2092 "tracker-builder.c"
	}
#line 632 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	(*array)[(*length)++] = value;
...
void tracker_sparql_builder_object_blank_close (TrackerSparqlBuilder* self) {
	...
	gint _tmp8_ = 0;
#line 627 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	g_return_if_fail (self != NULL);
#line 627 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	_tmp0_ = tracker_sparql_builder_get_state (self);
#line 627 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
...
#line 630 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	_tmp5_ = self->priv->str;
#line 630 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	g_string_append (_tmp5_, "]");
#line 631 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	self->priv->states_length1 = self->priv->states_length1 - 3;
#line 631 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
...
#line 634 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	_tmp8_ = self->priv->_length;
#line 634 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	tracker_sparql_builder_set_length (self, _tmp8_ + 1);
#line 2149 "tracker-builder.c"
}
...
#line 648 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
...
#line 648 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	_g_free0 (_tmp3_);
#line 650 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	_tmp4_ = self->priv->_length;
#line 650 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	tracker_sparql_builder_set_length (self, _tmp4_ + 1);
#line 2188 "tracker-builder.c"
}
...
#line 2217 "tracker-builder.c"
		GString* _tmp2_ = NULL;
		gint _tmp3_ = 0;
#line 665 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
		_tmp2_ = self->priv->str;
#line 665 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
		g_string_append (_tmp2_, " .\n");
#line 666 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
		self->priv->states_length1 = self->priv->states_length1 - 3;
#line 666 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
		_tmp3_ = self->priv->states_length1;
#line 2228 "tracker-builder.c"
	}
#line 669 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	_tmp4_ = self->priv->str;
#line 669 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	_tmp5_ = raw;
#line 669 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	g_string_append (_tmp4_, _tmp5_);
#line 671 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	_tmp6_ = self->priv->_length;
#line 671 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-builder.vala"
	tracker_sparql_builder_set_length (self, _tmp6_ + 1);
#line 2240 "tracker-builder.c"
}
