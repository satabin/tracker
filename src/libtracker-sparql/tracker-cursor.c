/* tracker-cursor.c generated by valac 0.19.0.3-f335, the Vala compiler
 ...
 */
static TrackerSparqlValueType tracker_sparql_cursor_real_get_value_type (TrackerSparqlCursor* self, gint column) {
#line 126 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
 ...
 */
static const gchar* tracker_sparql_cursor_real_get_variable_name (TrackerSparqlCursor* self, gint column) {
#line 139 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
 ...
 */
static const gchar* tracker_sparql_cursor_real_get_string (TrackerSparqlCursor* self, gint column, glong* length) {
#line 155 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
 ...
 */
static gboolean tracker_sparql_cursor_real_next (TrackerSparqlCursor* self, GCancellable* cancellable, GError** error) {
#line 170 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
void tracker_sparql_cursor_next_async (TrackerSparqlCursor* self, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_) {
#line 65 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
 ...
 */
static void tracker_sparql_cursor_real_rewind (TrackerSparqlCursor* self) {
#line 207 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
void tracker_sparql_cursor_close (TrackerSparqlCursor* self) {
#line 217 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_if_fail (self != NULL);
#line 217 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
static gint64 int64_parse (const gchar* str) {
	...
	const gchar* _tmp0_;
	gint64 _tmp1_ = 0LL;
#line 593 "/opt/gnome/share/vala-0.20/vapi/glib-2.0.vapi"
	g_return_val_if_fail (str != NULL, 0LL);
#line 594 "/opt/gnome/share/vala-0.20/vapi/glib-2.0.vapi"
	_tmp0_ = str;
#line 594 "/opt/gnome/share/vala-0.20/vapi/glib-2.0.vapi"
...
static gint64 tracker_sparql_cursor_real_get_integer (TrackerSparqlCursor* self, gint column) {
	...
	const gchar* as_str;
	gint64 _tmp4_ = 0LL;
#line 232 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp0_ = column;
#line 232 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp1_ = tracker_sparql_cursor_get_value_type (self, _tmp0_);
#line 232 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (_tmp1_ == TRACKER_SPARQL_VALUE_TYPE_INTEGER, 0);
#line 233 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp2_ = column;
#line 233 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp3_ = tracker_sparql_cursor_get_string (self, _tmp2_, NULL);
#line 233 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	as_str = _tmp3_;
#line 234 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
gint64 tracker_sparql_cursor_get_integer (TrackerSparqlCursor* self, gint column) {
#line 231 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
static gdouble double_parse (const gchar* str) {
	...
	const gchar* _tmp0_;
	gdouble _tmp1_ = 0.0;
#line 777 "/opt/gnome/share/vala-0.20/vapi/glib-2.0.vapi"
	g_return_val_if_fail (str != NULL, 0.0);
#line 778 "/opt/gnome/share/vala-0.20/vapi/glib-2.0.vapi"
	_tmp0_ = str;
#line 778 "/opt/gnome/share/vala-0.20/vapi/glib-2.0.vapi"
...
static gdouble tracker_sparql_cursor_real_get_double (TrackerSparqlCursor* self, gint column) {
	...
	const gchar* as_str;
	gdouble _tmp4_ = 0.0;
#line 249 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp0_ = column;
#line 249 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp1_ = tracker_sparql_cursor_get_value_type (self, _tmp0_);
#line 249 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (_tmp1_ == TRACKER_SPARQL_VALUE_TYPE_DOUBLE, 0);
#line 250 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp2_ = column;
#line 250 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp3_ = tracker_sparql_cursor_get_string (self, _tmp2_, NULL);
#line 250 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	as_str = _tmp3_;
#line 251 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
gdouble tracker_sparql_cursor_get_double (TrackerSparqlCursor* self, gint column) {
#line 248 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
static gboolean tracker_sparql_cursor_real_get_boolean (TrackerSparqlCursor* self, gint column) {
	...
	GCompareFunc _tmp4_;
	gint _tmp5_ = 0;
#line 266 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp0_ = column;
#line 266 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp1_ = tracker_sparql_cursor_get_value_type (self, _tmp0_);
#line 266 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	type = _tmp1_;
#line 267 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (type == TRACKER_SPARQL_VALUE_TYPE_BOOLEAN, 0);
#line 268 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp2_ = column;
#line 268 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp3_ = tracker_sparql_cursor_get_string (self, _tmp2_, NULL);
#line 268 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	as_str = _tmp3_;
#line 269 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp4_ = g_strcmp0;
#line 269 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
gboolean tracker_sparql_cursor_get_boolean (TrackerSparqlCursor* self, gint column) {
#line 265 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 265 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
static gboolean tracker_sparql_cursor_real_is_bound (TrackerSparqlCursor* self, gint column) {
	...
	gint _tmp0_;
	TrackerSparqlValueType _tmp1_ = 0;
#line 284 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp0_ = column;
#line 284 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp1_ = tracker_sparql_cursor_get_value_type (self, _tmp0_);
#line 284 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	if (_tmp1_ != TRACKER_SPARQL_VALUE_TYPE_UNBOUND) {
#line 285 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
		result = TRUE;
#line 285 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
		return result;
#line 587 "tracker-cursor.c"
	}
#line 287 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	result = FALSE;
#line 287 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	return result;
...
gboolean tracker_sparql_cursor_is_bound (TrackerSparqlCursor* self, gint column) {
#line 283 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 283 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
#line 85 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 85 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
#line 88 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
 ...
 */
gint tracker_sparql_cursor_get_n_columns (TrackerSparqlCursor* self) {
#line 112 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (self != NULL, 0);
#line 112 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
#line 74 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_g_object_unref0 (self->priv->_connection);
#line 65 "/home/martyn/Source/tracker/src/libtracker-sparql/tracker-cursor.vala"
