/* tracker-cursor.c generated by valac 0.14.0, the Vala compiler
 ...
 */
static TrackerSparqlValueType tracker_sparql_cursor_real_get_value_type (TrackerSparqlCursor* self, gint column) {
#line 126 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
 ...
 */
static const gchar* tracker_sparql_cursor_real_get_variable_name (TrackerSparqlCursor* self, gint column) {
#line 139 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
 ...
 */
static const gchar* tracker_sparql_cursor_real_get_string (TrackerSparqlCursor* self, gint column, glong* length) {
#line 155 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
 ...
 */
static gboolean tracker_sparql_cursor_real_next (TrackerSparqlCursor* self, GCancellable* cancellable, GError** error) {
#line 170 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
void tracker_sparql_cursor_next_async (TrackerSparqlCursor* self, GCancellable* cancellable, GAsyncReadyCallback _callback_, gpointer _user_data_) {
#line 65 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
 ...
 */
static void tracker_sparql_cursor_real_rewind (TrackerSparqlCursor* self) {
#line 207 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
void tracker_sparql_cursor_close (TrackerSparqlCursor* self) {
#line 217 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_if_fail (self != NULL);
#line 217 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
static gint64 int64_parse (const gchar* str) {
	...
	const gchar* _tmp0_;
	gint64 _tmp1_ = 0LL;
#line 593 "/usr/share/vala-0.14/vapi/glib-2.0.vapi"
	g_return_val_if_fail (str != NULL, 0LL);
#line 594 "/usr/share/vala-0.14/vapi/glib-2.0.vapi"
	_tmp0_ = str;
#line 594 "/usr/share/vala-0.14/vapi/glib-2.0.vapi"
...
static gint64 tracker_sparql_cursor_real_get_integer (TrackerSparqlCursor* self, gint column) {
	...
	const gchar* as_str;
	gint64 _tmp4_ = 0LL;
#line 232 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp0_ = column;
#line 232 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp1_ = tracker_sparql_cursor_get_value_type (self, _tmp0_);
#line 232 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (_tmp1_ == TRACKER_SPARQL_VALUE_TYPE_INTEGER, 0);
#line 233 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp2_ = column;
#line 233 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp3_ = tracker_sparql_cursor_get_string (self, _tmp2_, NULL);
#line 233 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	as_str = _tmp3_;
#line 234 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
gint64 tracker_sparql_cursor_get_integer (TrackerSparqlCursor* self, gint column) {
#line 231 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
static gdouble double_parse (const gchar* str) {
	...
	const gchar* _tmp0_;
	gdouble _tmp1_ = 0.0;
#line 773 "/usr/share/vala-0.14/vapi/glib-2.0.vapi"
	g_return_val_if_fail (str != NULL, 0.0);
#line 774 "/usr/share/vala-0.14/vapi/glib-2.0.vapi"
	_tmp0_ = str;
#line 774 "/usr/share/vala-0.14/vapi/glib-2.0.vapi"
...
static gdouble tracker_sparql_cursor_real_get_double (TrackerSparqlCursor* self, gint column) {
	...
	const gchar* as_str;
	gdouble _tmp4_ = 0.0;
#line 249 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp0_ = column;
#line 249 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp1_ = tracker_sparql_cursor_get_value_type (self, _tmp0_);
#line 249 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (_tmp1_ == TRACKER_SPARQL_VALUE_TYPE_DOUBLE, 0);
#line 250 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp2_ = column;
#line 250 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp3_ = tracker_sparql_cursor_get_string (self, _tmp2_, NULL);
#line 250 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	as_str = _tmp3_;
#line 251 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
gdouble tracker_sparql_cursor_get_double (TrackerSparqlCursor* self, gint column) {
#line 248 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
static gboolean tracker_sparql_cursor_real_get_boolean (TrackerSparqlCursor* self, gint column) {
	...
	GCompareFunc _tmp4_;
	gint _tmp5_ = 0;
#line 266 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp0_ = column;
#line 266 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp1_ = tracker_sparql_cursor_get_value_type (self, _tmp0_);
#line 266 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	type = _tmp1_;
#line 267 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (type == TRACKER_SPARQL_VALUE_TYPE_BOOLEAN, 0);
#line 268 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp2_ = column;
#line 268 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp3_ = tracker_sparql_cursor_get_string (self, _tmp2_, NULL);
#line 268 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	as_str = _tmp3_;
#line 269 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp4_ = g_strcmp0;
#line 269 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp5_ = _tmp4_ (as_str, "true");
#line 269 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	result = _tmp5_ == 0;
#line 269 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	return result;
...
gboolean tracker_sparql_cursor_get_boolean (TrackerSparqlCursor* self, gint column) {
#line 265 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 265 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
static gboolean tracker_sparql_cursor_real_is_bound (TrackerSparqlCursor* self, gint column) {
	...
	gint _tmp0_;
	TrackerSparqlValueType _tmp1_ = 0;
#line 284 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp0_ = column;
#line 284 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_tmp1_ = tracker_sparql_cursor_get_value_type (self, _tmp0_);
#line 284 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	if (_tmp1_ != TRACKER_SPARQL_VALUE_TYPE_UNBOUND) {
#line 285 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
		result = TRUE;
#line 285 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
		return result;
#line 587 "tracker-cursor.c"
	}
#line 287 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	result = FALSE;
#line 287 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	return result;
#line 593 "tracker-cursor.c"
}


gboolean tracker_sparql_cursor_is_bound (TrackerSparqlCursor* self, gint column) {
#line 283 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 283 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	return TRACKER_SPARQL_CURSOR_GET_CLASS (self)->is_bound (self, column);
#line 602 "tracker-cursor.c"
}
...
#line 85 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 85 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
...
#line 85 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	return result;
#line 637 "tracker-cursor.c"
}


static gpointer _g_object_ref0 (gpointer self) {
#line 88 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	return self ? g_object_ref (self) : NULL;
#line 644 "tracker-cursor.c"
}
 ...
 */
gint tracker_sparql_cursor_get_n_columns (TrackerSparqlCursor* self) {
#line 112 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	g_return_val_if_fail (self != NULL, 0);
#line 112 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	return TRACKER_SPARQL_CURSOR_GET_CLASS (self)->get_n_columns (self);
#line 685 "tracker-cursor.c"
}
...
#line 74 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	_g_object_unref0 (self->priv->_connection);
#line 65 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
	G_OBJECT_CLASS (tracker_sparql_cursor_parent_class)->finalize (obj);
#line 759 "tracker-cursor.c"
}
...
#line 65 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
		break;
#line 814 "tracker-cursor.c"
		default:
#line 65 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
		G_OBJECT_WARN_INVALID_PROPERTY_ID (object, property_id, pspec);
#line 65 "/home/juerg/Code/tracker/tracker/src/libtracker-sparql/tracker-cursor.vala"
		break;
#line 820 "tracker-cursor.c"
	}
}
