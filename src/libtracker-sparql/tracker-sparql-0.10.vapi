/* tracker-sparql-0.10.vapi generated by valac 0.11.5, do not modify. */

[CCode (cprefix = "Tracker", lower_case_cprefix = "tracker_")]
namespace Tracker {
	[CCode (cprefix = "TrackerBackend", lower_case_cprefix = "tracker_backend_")]
	namespace Backend {
	}
	[CCode (cprefix = "TrackerSparql", lower_case_cprefix = "tracker_sparql_")]
	namespace Sparql {
		[CCode (cheader_filename = "libtracker-sparql/tracker-sparql.h")]
		public class Builder : GLib.Object {
			[CCode (cprefix = "TRACKER_SPARQL_BUILDER_STATE_", cheader_filename = "libtracker-sparql/tracker-sparql.h")]
			public enum State {
				UPDATE,
				INSERT,
				DELETE,
		...
		public abstract class Connection : GLib.Object {
			public Connection ();
			public static new Tracker.Sparql.Connection @get (GLib.Cancellable? cancellable = null) throws Tracker.Sparql.Error, GLib.IOError, GLib.DBusError;
			public static new async Tracker.Sparql.Connection get_async (GLib.Cancellable? cancellable = null) throws Tracker.Sparql.Error, GLib.IOError, GLib.DBusError;
		...
		[CCode (cprefix = "TRACKER_SPARQL_VALUE_TYPE_", cheader_filename = "libtracker-sparql/tracker-sparql.h")]
		...
		[CCode (cprefix = "TRACKER_SPARQL_ERROR_", cheader_filename = "libtracker-sparql/tracker-sparql.h")]
