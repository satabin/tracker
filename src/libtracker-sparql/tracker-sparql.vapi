/* tracker-sparql.vapi generated by valac 0.12.0.69-6c49, do not modify. */

[CCode (cprefix = "Tracker", lower_case_cprefix = "tracker_", gir_namespace = "Tracker", gir_version = "0.10")]
namespace Tracker {
	...
	namespace Sparql {
		...
		public class Builder : GLib.Object {
			[CCode (cprefix = "TRACKER_SPARQL_BUILDER_STATE_", cheader_filename = "libtracker-sparql/tracker-generated-no-checks.h")]
			public enum State {
				UPDATE,
				INSERT,
				DELETE,
		...
		public abstract class Connection : GLib.Object {
			...
			public virtual void init () throws Tracker.Sparql.Error, GLib.IOError, GLib.DBusError, GLib.SpawnError;
		...
		[CCode (cprefix = "TRACKER_SPARQL_VALUE_TYPE_", cheader_filename = "libtracker-sparql/tracker-generated-no-checks.h")]
		...
		[CCode (cprefix = "TRACKER_SPARQL_ERROR_", cheader_filename = "libtracker-sparql/tracker-generated-no-checks.h")]
