/* tracker-explorer.c generated by valac 0.9.5.4-19a5, the Vala compiler
...
#line 173 "tracker-explorer.vala"
	self->priv->uris = (_tmp0_ = gtk_list_store_new (1, G_TYPE_STRING), _g_object_unref0 (self->priv->uris), _tmp0_);
...
#line 181 "tracker-explorer.vala"
	self->priv->relationships = (_tmp0_ = gtk_list_store_new (3, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING), _g_object_unref0 (self->priv->relationships), _tmp0_);
...
#line 191 "tracker-explorer.vala"
	reverserelationships = gtk_list_store_new (3, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING);
