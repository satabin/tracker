...
#ifndef __dbus_glib_marshal_tracker_extract_MARSHAL_H__
#define __dbus_glib_marshal_tracker_extract_MARSHAL_H__
...
/* NONE:STRING,STRING,POINTER (/tmp/dbus-binding-tool-c-marshallers.Y5Z2BV:1) */
...
void
dbus_glib_marshal_tracker_extract_VOID__STRING_STRING_POINTER (GClosure     *closure,
...
/* NONE:POINTER (/tmp/dbus-binding-tool-c-marshallers.Y5Z2BV:2) */
...
static const DBusGMethodInfo dbus_glib_tracker_extract_methods[] = {
  { (GCallback) tracker_extract_get_pid, dbus_glib_marshal_tracker_extract_NONE__POINTER, 0 },
