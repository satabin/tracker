...
static gboolean tracker_needle_search_detailed_co (TrackerNeedleSearchDetailedData* data) {
	...
	data->_categories_size_ = data->categories_length1;
	data->categories = data->_tmp1_;
	data->_tmp2_ = NULL;
	data->_tmp2_ = tracker_query_new ();
	data->query = data->_tmp2_;
	gtk_list_store_clear (data->store);
	g_debug ("tracker-needle.vala:300: Doing detailed search using store:%p", data->store);
	data->_tmp3_ = NULL;
	data->_tmp3_ = gtk_window_get_screen (data->self->priv->window);
	data->_tmp4_ = _g_object_ref0 (data->_tmp3_);
	data->screen = data->_tmp4_;
	data->_tmp5_ = NULL;
	data->_tmp5_ = gtk_icon_theme_get_for_screen (data->screen);
	data->_tmp6_ = _g_object_ref0 (data->_tmp5_);
	data->theme = data->_tmp6_;
	data->odd = FALSE;
	{
		...
		for (data->type_it = 0; data->type_it < data->categories_length1; data->type_it = data->type_it + 1) {
			data->type = data->type_collection[data->type_it];
			{
				...
				tracker_query_set_limit (data->query, (guint) 1000);
				data->_tmp7_ = NULL;
				data->_tmp7_ = gtk_entry_get_text (data->self->priv->search);
				tracker_query_set_criteria (data->query, data->_tmp7_);
				data->_state_ = 1;
				tracker_query_perform_async (data->query, data->type, NULL, tracker_needle_search_detailed_ready, data);
				return FALSE;
				_state_1:
				data->_tmp8_ = NULL;
				data->_tmp8_ = tracker_query_perform_finish (data->query, data->_res_, &data->_inner_error_);
				...
				while (TRUE) {
					...
					return FALSE;
					_state_2:
					data->_tmp11_ = tracker_sparql_cursor_next_finish (data->cursor, data->_res_, &data->_inner_error_);
					data->b = data->_tmp11_;
					if (data->_inner_error_ != NULL) {
						goto __catch16_g_error;
					}
					...
					}
					{
						data->i = 0;
						{
							...
							while (TRUE) {
								...
								data->_tmp12_ = FALSE;
								data->_tmp13_ = tracker_sparql_cursor_get_n_columns (data->cursor);
								if (!(data->i < data->_tmp13_)) {
									break;
								}
								if (data->i == 0) {
									data->_tmp14_ = NULL;
									data->_tmp14_ = tracker_sparql_cursor_get_string (data->cursor, data->i, NULL);
									g_debug ("tracker-needle.vala:330: --> %s", data->_tmp14_);
								} else {
									data->_tmp15_ = NULL;
									data->_tmp15_ = tracker_sparql_cursor_get_string (data->cursor, data->i, NULL);
									g_debug ("tracker-needle.vala:332:   --> %s", data->_tmp15_);
								}
							}
						}
					}
					data->_tmp16_ = NULL;
					data->_tmp16_ = tracker_sparql_cursor_get_string (data->cursor, 0, NULL);
					data->_tmp17_ = g_strdup (data->_tmp16_);
					data->urn = data->_tmp17_;
					data->_tmp18_ = NULL;
					data->_tmp18_ = tracker_sparql_cursor_get_string (data->cursor, 1, NULL);
					data->_tmp19_ = g_strdup (data->_tmp18_);
					data->_file = data->_tmp19_;
					data->_tmp20_ = NULL;
					data->_tmp20_ = tracker_sparql_cursor_get_string (data->cursor, 2, NULL);
					data->_tmp21_ = g_strdup (data->_tmp20_);
					data->title = data->_tmp21_;
					data->subtitle = NULL;
					data->column2 = NULL;
					data->column3 = NULL;
					data->_tmp22_ = NULL;
					data->_tmp22_ = tracker_sparql_cursor_get_string (data->cursor, 5, NULL);
					data->_tmp23_ = g_strdup (data->_tmp22_);
					data->tooltip = data->_tmp23_;
					...
					switch (data->type) {
						case TRACKER_QUERY_TYPE_APPLICATIONS:
						{
							if (data->count == 0) {
								data->_tmp24_ = NULL;
								data->_tmp24_ = tracker_pixbuf_new_from_name (data->theme, "package-x-generic", data->self->priv->size_medium);
								data->_tmp25_ = data->_tmp24_;
								_g_object_unref0 (data->pixbuf_small);
								data->pixbuf_small = data->_tmp25_;
							}
							break;
						}
						case TRACKER_QUERY_TYPE_MUSIC:
						{
							if (data->count == 0) {
								data->_tmp26_ = NULL;
								data->_tmp26_ = tracker_pixbuf_new_from_name (data->theme, "audio-x-generic", data->self->priv->size_medium);
								data->_tmp27_ = data->_tmp26_;
								_g_object_unref0 (data->pixbuf_small);
								data->pixbuf_small = data->_tmp27_;
							}
							data->_tmp28_ = NULL;
							data->_tmp28_ = tracker_sparql_cursor_get_string (data->cursor, 4, NULL);
							data->_tmp29_ = NULL;
							data->_tmp29_ = tracker_time_format_from_seconds (data->_tmp28_);
							data->_tmp30_ = data->_tmp29_;
							_g_free0 (data->column2);
							data->column2 = data->_tmp30_;
							break;
						}
						case TRACKER_QUERY_TYPE_IMAGES:
						{
							if (data->count == 0) {
								data->_tmp31_ = NULL;
								data->_tmp31_ = tracker_pixbuf_new_from_name (data->theme, "image-x-generic", data->self->priv->size_medium);
								data->_tmp32_ = data->_tmp31_;
								_g_object_unref0 (data->pixbuf_small);
								data->pixbuf_small = data->_tmp32_;
							}
							data->_tmp33_ = NULL;
							data->_tmp33_ = tracker_sparql_cursor_get_string (data->cursor, 4, NULL);
							data->_tmp34_ = atoi (data->_tmp33_);
							data->_tmp35_ = NULL;
							data->_tmp35_ = g_format_size_for_display ((gint64) data->_tmp34_);
							data->_tmp36_ = data->_tmp35_;
							_g_free0 (data->column2);
							data->column2 = data->_tmp36_;
							break;
						}
						case TRACKER_QUERY_TYPE_VIDEOS:
						{
							if (data->count == 0) {
								data->_tmp37_ = NULL;
								data->_tmp37_ = tracker_pixbuf_new_from_name (data->theme, "video-x-generic", data->self->priv->size_medium);
								data->_tmp38_ = data->_tmp37_;
								_g_object_unref0 (data->pixbuf_small);
								data->pixbuf_small = data->_tmp38_;
							}
							data->_tmp39_ = NULL;
							data->_tmp39_ = tracker_sparql_cursor_get_string (data->cursor, 4, NULL);
							data->_tmp40_ = NULL;
							data->_tmp40_ = tracker_time_format_from_seconds (data->_tmp39_);
							data->_tmp41_ = data->_tmp40_;
							_g_free0 (data->column2);
							data->column2 = data->_tmp41_;
							break;
						}
						case TRACKER_QUERY_TYPE_DOCUMENTS:
						{
							if (data->count == 0) {
								data->_tmp42_ = NULL;
								data->_tmp42_ = tracker_pixbuf_new_from_name (data->theme, "x-office-presentation", data->self->priv->size_medium);
								data->_tmp43_ = data->_tmp42_;
								_g_object_unref0 (data->pixbuf_small);
								data->pixbuf_small = data->_tmp43_;
							}
							break;
						}
						case TRACKER_QUERY_TYPE_MAIL:
						{
							if (data->count == 0) {
								data->_tmp44_ = NULL;
								data->_tmp44_ = tracker_pixbuf_new_from_name (data->theme, "emblem-mail", data->self->priv->size_medium);
								data->_tmp45_ = data->_tmp44_;
								_g_object_unref0 (data->pixbuf_small);
								data->pixbuf_small = data->_tmp45_;
							}
							data->_tmp46_ = NULL;
							data->_tmp46_ = tracker_sparql_cursor_get_string (data->cursor, 4, NULL);
							data->_tmp47_ = NULL;
							data->_tmp47_ = tracker_time_format_from_iso8601 (data->_tmp46_);
							data->_tmp48_ = data->_tmp47_;
							_g_free0 (data->column2);
							data->column2 = data->_tmp48_;
							break;
						}
						case TRACKER_QUERY_TYPE_FOLDERS:
						{
							if (data->count == 0) {
								data->_tmp49_ = NULL;
								data->_tmp49_ = tracker_pixbuf_new_from_name (data->theme, "folder", data->self->priv->size_medium);
								data->_tmp50_ = data->_tmp49_;
								_g_object_unref0 (data->pixbuf_small);
								data->pixbuf_small = data->_tmp50_;
							}
							data->_tmp51_ = NULL;
							data->_tmp51_ = tracker_sparql_cursor_get_string (data->cursor, 4, NULL);
							data->_tmp52_ = NULL;
							data->_tmp52_ = tracker_time_format_from_iso8601 (data->_tmp51_);
							data->_tmp53_ = data->_tmp52_;
							_g_free0 (data->column2);
							data->column2 = data->_tmp53_;
							break;
						}
						default:
						{
					...
					if (data->subtitle == NULL) {
						data->_tmp54_ = NULL;
						data->_tmp54_ = tracker_sparql_cursor_get_string (data->cursor, 3, NULL);
						data->_tmp55_ = g_strdup (data->_tmp54_);
						data->_tmp56_ = data->_tmp55_;
						_g_free0 (data->subtitle);
						data->subtitle = data->_tmp56_;
					}
					if (data->column2 == NULL) {
						data->_tmp57_ = NULL;
						data->_tmp57_ = tracker_sparql_cursor_get_string (data->cursor, 4, NULL);
						data->_tmp58_ = g_strdup (data->_tmp57_);
						data->_tmp59_ = data->_tmp58_;
						_g_free0 (data->column2);
						data->column2 = data->_tmp59_;
					}
					memset (&data->_tmp60_, 0, sizeof (GtkTreeIter));
					gtk_list_store_append (data->store, &data->_tmp60_);
					data->iter = data->_tmp60_;
...
static void tracker_needle_launch_selected (TrackerNeedle* self, GtkTreeModel* model, GtkTreePath* path, gint col) {
	...
	if (_tmp1_ < 1) {
		...
		__catch17_g_error:
		{
			...
			g_warning ("tracker-needle.vala:616: Could not launch '%s', %d->%s", command[0], e->code, _tmp10_);
			_g_error_free0 (e);
	...
	__catch18_g_error:
	{
		...
		g_warning ("tracker-needle.vala:628: %s", _tmp11_);
		_g_free0 (_tmp11_);
		_g_error_free0 (e);
	}
	__finally18:
