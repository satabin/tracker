/* tracker-result-store.c generated by valac 0.16.1, the Vala compiler
...
static void tracker_result_store_real_get_value (GtkTreeModel* base, GtkTreeIter* iter, gint column, GValue* value) {
	...
	_tmp9_ = _tracker_result_store_category_node_ref0 (TRACKER_RESULT_STORE_CATEGORY_NODE (_tmp8_));
	_tracker_result_store_category_node_unref0 (cat);
	cat = _tmp9_;
	_tmp10_ = column;
