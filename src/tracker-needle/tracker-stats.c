/* tracker-stats.c generated by valac 0.11.5, the Vala compiler
...
"her the total data stored:");
	...
	}
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				static GQuark _tmp12__label2 = 0;
				static GQuark _tmp12__label3 = 0;
				static GQuark _tmp12__label4 = 0;
				static GQuark _tmp12__label5 = 0;
				static GQuark _tmp12__label6 = 0;
				static GQuark _tmp12__label7 = 0;
				static GQuark _tmp12__label8 = 0;
				static GQuark _tmp12__label9 = 0;
				static GQuark _tmp12__label10 = 0;
				...
				_tmp9_ = g_strdup (_result_[(i * _result__length2) + 0]);
				key = _tmp9_;
				...
				if (_tmp12_ == ((0 != _tmp12__label0) ? _tmp12__label0 : (_tmp12__label0 = g_quark_from_static_string ("nao:Tag")))) {
					switch (0) {
						default:
						{
							...
							gchar* _tmp16_;
							_tmp13_ = atoi (val);
							_tmp14_ = ngettext ("Tag", "Tags", (gulong) _tmp13_);
				...
				} else if (_tmp12_ == ((0 != _tmp12__label1) ? _tmp12__label1 : (_tmp12__label1 = g_quark_from_static_string ("nco:Contact")))) {
					switch (0) {
						default:
						{
							gint _tmp17_;
							...
							gchar* _tmp20_;
							_tmp17_ = atoi (val);
							_tmp18_ = ngettext ("Contact", "Contacts", (gulong) _tmp17_);
				...
				} else if (_tmp12_ == ((0 != _tmp12__label2) ? _tmp12__label2 : (_tmp12__label2 = g_quark_from_static_string ("nfo:Audio")))) {
					switch (0) {
						default:
						{
							gint _tmp21_;
							...
							gchar* _tmp24_;
							_tmp21_ = atoi (val);
							_tmp22_ = ngettext ("Audio", "Audios", (gulong) _tmp21_);
				...
				} else if (_tmp12_ == ((0 != _tmp12__label3) ? _tmp12__label3 : (_tmp12__label3 = g_quark_from_static_string ("nfo:Document")))) {
					switch (0) {
						default:
						{
							gint _tmp25_;
							...
							gchar* _tmp28_;
							_tmp25_ = atoi (val);
							_tmp26_ = ngettext ("Document", "Documents", (gulong) _tmp25_);
				...
				} else if (_tmp12_ == ((0 != _tmp12__label4) ? _tmp12__label4 : (_tmp12__label4 = g_quark_from_static_string ("nfo:FileDataObject")))) {
					switch (0) {
						default:
						{
							gint _tmp29_;
							...
							gchar* _tmp32_;
							_tmp29_ = atoi (val);
							_tmp30_ = ngettext ("File", "Files", (gulong) _tmp29_);
				...
				} else if (_tmp12_ == ((0 != _tmp12__label5) ? _tmp12__label5 : (_tmp12__label5 = g_quark_from_static_string ("nfo:Folder")))) {
					switch (0) {
						default:
						{
							gint _tmp33_;
							...
							gchar* _tmp36_;
							_tmp33_ = atoi (val);
							_tmp34_ = ngettext ("Folder", "Folders", (gulong) _tmp33_);
				...
				} else if (_tmp12_ == ((0 != _tmp12__label6) ? _tmp12__label6 : (_tmp12__label6 = g_quark_from_static_string ("nfo:Image")))) {
					switch (0) {
						default:
						{
							gint _tmp37_;
							...
							gchar* _tmp40_;
							_tmp37_ = atoi (val);
							_tmp38_ = ngettext ("Image", "Images", (gulong) _tmp37_);
				...
				} else if (_tmp12_ == ((0 != _tmp12__label7) ? _tmp12__label7 : (_tmp12__label7 = g_quark_from_static_string ("nfo:SoftwareApplication")))) {
					switch (0) {
						default:
						{
							gint _tmp41_;
							...
							gchar* _tmp44_;
							_tmp41_ = atoi (val);
							_tmp42_ = ngettext ("Application", "Applications", (gulong) _tmp41_);
				...
				} else if (_tmp12_ == ((0 != _tmp12__label8) ? _tmp12__label8 : (_tmp12__label8 = g_quark_from_static_string ("nfo:Video")))) {
					switch (0) {
						default:
						{
							gint _tmp45_;
							...
							gchar* _tmp48_;
							_tmp45_ = atoi (val);
							_tmp46_ = ngettext ("Video", "Videos", (gulong) _tmp45_);
				...
				} else if (_tmp12_ == ((0 != _tmp12__label9) ? _tmp12__label9 : (_tmp12__label9 = g_quark_from_static_string ("nmm:MusicAlbum")))) {
					switch (0) {
						default:
						{
							gint _tmp49_;
							...
							gchar* _tmp52_;
							_tmp49_ = atoi (val);
							_tmp50_ = ngettext ("Album", "Albums", (gulong) _tmp49_);
				...
				} else if (_tmp12_ == ((0 != _tmp12__label10) ? _tmp12__label10 : (_tmp12__label10 = g_quark_from_static_string ("nmm:MusicPiece")))) {
					switch (0) {
						default:
						{
							gint _tmp53_;
							...
							gchar* _tmp56_;
							_tmp53_ = atoi (val);
							_tmp54_ = ngettext ("Music Track", "Music Tracks", (gulong) _tmp53_);
				...
				} else if (_tmp12_ == ((0 != _tmp12__label11) ? _tmp12__label11 : (_tmp12__label11 = g_quark_from_static_string ("nmm:Photo")))) {
					switch (0) {
						default:
						{
							gint _tmp57_;
							...
							gchar* _tmp60_;
							_tmp57_ = atoi (val);
							_tmp58_ = ngettext ("Photo", "Photos", (gulong) _tmp57_);
				...
				} else if (_tmp12_ == ((0 != _tmp12__label12) ? _tmp12__label12 : (_tmp12__label12 = g_quark_from_static_string ("nmm:Playlist")))) {
					switch (0) {
						default:
						{
							gint _tmp61_;
							...
							gchar* _tmp64_;
							_tmp61_ = atoi (val);
							_tmp62_ = ngettext ("Playlist", "Playlists", (gulong) _tmp61_);
				...
				} else if (_tmp12_ == ((0 != _tmp12__label13) ? _tmp12__label13 : (_tmp12__label13 = g_quark_from_static_string ("nmo:Email")))) {
					switch (0) {
						default:
						{
							gint _tmp65_;
							...
							gchar* _tmp68_;
							_tmp65_ = atoi (val);
							_tmp66_ = ngettext ("Email", "Emails", (gulong) _tmp65_);
				...
				_tmp69_ = (GtkHBox*) gtk_hbox_new (FALSE, 12);
				hbox = g_object_ref_sink (_tmp69_);
				_tmp70_ = (GtkLabel*) gtk_label_new (key_used);
				label_key = g_object_ref_sink (_tmp70_);
				_tmp71_ = (GtkLabel*) gtk_label_new (val);
				label_val = g_object_ref_sink (_tmp71_);
	...
	__catch6_g_dbus_error:
	{
		...
		e = _inner_error_;
		_inner_error_ = NULL;
		_tmp72_ = g_strconcat ("Could not get Tracker statistics: ", e->message, NULL);
		g_warning ("tracker-stats.vala:153: %s", _tmp72_);
		_g_free0 (_tmp72_);
		_g_error_free0 (e);
	}
	__finally6:
