/* tracker-stats.c generated by valac 0.11.4, the Vala compiler
...
"her the total data stored:");
	...
	}
	{
		...
		i = 0;
		{
			...
			while (TRUE) {
				...
				static GQuark _tmp13__label7 = 0;
				static GQuark _tmp13__label8 = 0;
				static GQuark _tmp13__label9 = 0;
				static GQuark _tmp13__label10 = 0;
				static GQuark _tmp13__label11 = 0;
				static GQuark _tmp13__label12 = 0;
				static GQuark _tmp13__label13 = 0;
				...
				_tmp10_ = g_strdup (_result_[(i * _result__length2) + 0]);
				key = _tmp10_;
				_tmp11_ = g_strdup (_result_[(i * _result__length2) + 1]);
				val = _tmp11_;
				key_used = NULL;
				g_debug ("tracker-stats.vala:88: --> %s = %s", key, val);
				_tmp12_ = key;
				_tmp13_ = (NULL == _tmp12_) ? 0 : g_quark_from_string (_tmp12_);
				if (_tmp13_ == ((0 != _tmp13__label0) ? _tmp13__label0 : (_tmp13__label0 = g_quark_from_static_string ("nao:Tag")))) {
					switch (0) {
						default:
						{
							gint _tmp14_;
							...
							gchar* _tmp17_;
							_tmp14_ = atoi (val);
							_tmp15_ = ngettext ("Tag", "Tags", (gulong) _tmp14_);
				...
				} else if (_tmp13_ == ((0 != _tmp13__label1) ? _tmp13__label1 : (_tmp13__label1 = g_quark_from_static_string ("nco:Contact")))) {
					switch (0) {
						default:
						{
							gint _tmp18_;
							...
							gchar* _tmp21_;
							_tmp18_ = atoi (val);
							_tmp19_ = ngettext ("Contact", "Contacts", (gulong) _tmp18_);
				...
				} else if (_tmp13_ == ((0 != _tmp13__label2) ? _tmp13__label2 : (_tmp13__label2 = g_quark_from_static_string ("nfo:Audio")))) {
					switch (0) {
						default:
						{
							gint _tmp22_;
							...
							gchar* _tmp25_;
							_tmp22_ = atoi (val);
							_tmp23_ = ngettext ("Audio", "Audios", (gulong) _tmp22_);
				...
				} else if (_tmp13_ == ((0 != _tmp13__label3) ? _tmp13__label3 : (_tmp13__label3 = g_quark_from_static_string ("nfo:Document")))) {
					switch (0) {
						default:
						{
							gint _tmp26_;
							...
							gchar* _tmp29_;
							_tmp26_ = atoi (val);
							_tmp27_ = ngettext ("Document", "Documents", (gulong) _tmp26_);
				...
				} else if (_tmp13_ == ((0 != _tmp13__label4) ? _tmp13__label4 : (_tmp13__label4 = g_quark_from_static_string ("nfo:FileDataObject")))) {
					switch (0) {
						default:
						{
							gint _tmp30_;
							...
							gchar* _tmp33_;
							_tmp30_ = atoi (val);
							_tmp31_ = ngettext ("File", "Files", (gulong) _tmp30_);
				...
				} else if (_tmp13_ == ((0 != _tmp13__label5) ? _tmp13__label5 : (_tmp13__label5 = g_quark_from_static_string ("nfo:Folder")))) {
					switch (0) {
						default:
						{
							gint _tmp34_;
							...
							gchar* _tmp37_;
							_tmp34_ = atoi (val);
							_tmp35_ = ngettext ("Folder", "Folders", (gulong) _tmp34_);
				...
				} else if (_tmp13_ == ((0 != _tmp13__label6) ? _tmp13__label6 : (_tmp13__label6 = g_quark_from_static_string ("nfo:Image")))) {
					switch (0) {
						default:
						{
							gint _tmp38_;
							...
							gchar* _tmp41_;
							_tmp38_ = atoi (val);
							_tmp39_ = ngettext ("Image", "Images", (gulong) _tmp38_);
				...
				} else if (_tmp13_ == ((0 != _tmp13__label7) ? _tmp13__label7 : (_tmp13__label7 = g_quark_from_static_string ("nfo:SoftwareApplication")))) {
					switch (0) {
						default:
						{
							gint _tmp42_;
							...
							gchar* _tmp45_;
							_tmp42_ = atoi (val);
							_tmp43_ = ngettext ("Application", "Applications", (gulong) _tmp42_);
				...
				} else if (_tmp13_ == ((0 != _tmp13__label8) ? _tmp13__label8 : (_tmp13__label8 = g_quark_from_static_string ("nfo:Video")))) {
					switch (0) {
						default:
						{
							gint _tmp46_;
							...
							gchar* _tmp49_;
							_tmp46_ = atoi (val);
							_tmp47_ = ngettext ("Video", "Videos", (gulong) _tmp46_);
				...
				} else if (_tmp13_ == ((0 != _tmp13__label9) ? _tmp13__label9 : (_tmp13__label9 = g_quark_from_static_string ("nmm:MusicAlbum")))) {
					switch (0) {
						default:
						{
							gint _tmp50_;
							...
							gchar* _tmp53_;
							_tmp50_ = atoi (val);
							_tmp51_ = ngettext ("Album", "Albums", (gulong) _tmp50_);
				...
				} else if (_tmp13_ == ((0 != _tmp13__label10) ? _tmp13__label10 : (_tmp13__label10 = g_quark_from_static_string ("nmm:MusicPiece")))) {
					switch (0) {
						default:
						{
							gint _tmp54_;
							...
							gchar* _tmp57_;
							_tmp54_ = atoi (val);
							_tmp55_ = ngettext ("Music Track", "Music Tracks", (gulong) _tmp54_);
				...
				} else if (_tmp13_ == ((0 != _tmp13__label11) ? _tmp13__label11 : (_tmp13__label11 = g_quark_from_static_string ("nmm:Photo")))) {
					switch (0) {
						default:
						{
							gint _tmp58_;
							...
							gchar* _tmp61_;
							_tmp58_ = atoi (val);
							_tmp59_ = ngettext ("Photo", "Photos", (gulong) _tmp58_);
				...
				} else if (_tmp13_ == ((0 != _tmp13__label12) ? _tmp13__label12 : (_tmp13__label12 = g_quark_from_static_string ("nmm:Playlist")))) {
					switch (0) {
						default:
						{
							gint _tmp62_;
							...
							gchar* _tmp65_;
							_tmp62_ = atoi (val);
							_tmp63_ = ngettext ("Playlist", "Playlists", (gulong) _tmp62_);
				...
				} else if (_tmp13_ == ((0 != _tmp13__label13) ? _tmp13__label13 : (_tmp13__label13 = g_quark_from_static_string ("nmo:Email")))) {
					switch (0) {
						default:
						{
							gint _tmp66_;
							...
							gchar* _tmp69_;
							_tmp66_ = atoi (val);
							_tmp67_ = ngettext ("Email", "Emails", (gulong) _tmp66_);
				...
				hbox = g_object_ref_sink (_tmp70_);
				_tmp71_ = (GtkLabel*) gtk_label_new (key_used);
				label_key = g_object_ref_sink (_tmp71_);
				_tmp72_ = (GtkLabel*) gtk_label_new (val);
				label_val = g_object_ref_sink (_tmp72_);
	...
	__catch12_g_dbus_error:
	{
		...
		e = _inner_error_;
		_inner_error_ = NULL;
		_tmp73_ = g_strconcat ("Could not get Tracker statistics: ", e->message, NULL);
		g_warning ("tracker-stats.vala:153: %s", _tmp73_);
		_g_free0 (_tmp73_);
		_g_error_free0 (e);
	}
	__finally12:
