/* tracker-stats.c generated by valac 0.12.0.69-6c49, the Vala compiler
...
static void tracker_stats_setup_dbus (TrackerStats* self) {
	...
	__catch11_g_io_error:
	{
		...
		e = _inner_error_;
		_inner_error_ = NULL;
		_tmp2_ = (GtkMessageDialog*) gtk_message_dialog_new (NULL, GTK_DIALOG_MODAL, GTK_MESSAGE_ERROR, GTK_BUTTONS_CANCEL, "Error connecting to D-Bus session bus, %s", e->message);
				...
				if (_tmp12_ == ((0 != _tmp12__label0) ? _tmp12__label0 : (_tmp12__label0 = g_quark_from_static_string ("nao:Tag")))) {
					...
					switch (0) {
						default:
						{
							...
							gchar* _tmp18_;
							_tmp16_ = atoi (val);
							_tmp17_ = ngettext ("Contact", "Contacts", (gulong) _tmp16_);
					...
					switch (0) {
						default:
						{
							...
							gchar* _tmp24_;
							_tmp22_ = atoi (val);
							_tmp23_ = ngettext ("Document", "Documents", (gulong) _tmp22_);
					...
					switch (0) {
						default:
						{
							...
							gchar* _tmp27_;
							_tmp25_ = atoi (val);
							_tmp26_ = ngettext ("File", "Files", (gulong) _tmp25_);
					...
					switch (0) {
						default:
						{
							...
							gchar* _tmp30_;
							_tmp28_ = atoi (val);
							_tmp29_ = ngettext ("Folder", "Folders", (gulong) _tmp28_);
					...
					switch (0) {
						default:
						{
							...
							gchar* _tmp33_;
							_tmp31_ = atoi (val);
							_tmp32_ = ngettext ("Image", "Images", (gulong) _tmp31_);
					...
					switch (0) {
						default:
						{
							...
							gchar* _tmp36_;
							_tmp34_ = atoi (val);
							_tmp35_ = ngettext ("Application", "Applications", (gulong) _tmp34_);
					...
					switch (0) {
						default:
						{
							...
							gchar* _tmp39_;
							_tmp37_ = atoi (val);
							_tmp38_ = ngettext ("Video", "Videos", (gulong) _tmp37_);
					...
					switch (0) {
						default:
						{
							...
							gchar* _tmp42_;
							_tmp40_ = atoi (val);
							_tmp41_ = ngettext ("Album", "Albums", (gulong) _tmp40_);
					...
					switch (0) {
						default:
						{
							...
							gchar* _tmp45_;
							_tmp43_ = atoi (val);
							_tmp44_ = ngettext ("Music Track", "Music Tracks", (gulong) _tmp43_);
					...
					switch (0) {
						default:
						{
							...
							gchar* _tmp48_;
							_tmp46_ = atoi (val);
							_tmp47_ = ngettext ("Photo", "Photos", (gulong) _tmp46_);
					...
					switch (0) {
						default:
						{
							...
							gchar* _tmp51_;
							_tmp49_ = atoi (val);
							_tmp50_ = ngettext ("Playlist", "Playlists", (gulong) _tmp49_);
					...
					switch (0) {
						default:
						{
							...
							gchar* _tmp54_;
							_tmp52_ = atoi (val);
							_tmp53_ = ngettext ("Email", "Emails", (gulong) _tmp52_);
