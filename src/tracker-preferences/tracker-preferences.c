...
void radiobutton_visibility_toggled_cb (GtkRadioButton* source) {
	...
	_tmp0_ = gtk_toggle_button_get_active ((GtkToggleButton*) radiobutton_display_never);
	if (_tmp0_) {
		tracker_icon_config_set_visibility (icon_config, 0);
	} else {
		gboolean _tmp1_;
		_tmp1_ = gtk_toggle_button_get_active ((GtkToggleButton*) radiobutton_display_active);
		if (_tmp1_) {
...
void initialize_visibility_radiobutton (void) {
	gint _tmp0_;
	_tmp0_ = tracker_icon_config_get_visibility (icon_config);
	if (_tmp0_ == 0) {
		gtk_toggle_button_set_active ((GtkToggleButton*) radiobutton_display_never, TRUE);
	} else {
		gint _tmp1_;
		_tmp1_ = tracker_icon_config_get_visibility (icon_config);
		if (_tmp1_ == 1) {
...
void add_freevalue (GtkListStore* model) {
	...
	_tmp1_ = (GtkDialog*) gtk_dialog_new_with_buttons (_tmp0_, window, GTK_DIALOG_DESTROY_WITH_PARENT | GTK_DIALOG_NO_SEPARATOR, GTK_STOCK_CANCEL, GTK_RESPONSE_CANCEL, GTK_STOCK_OK, GTK_RESPONSE_ACCEPT, NULL);
...
gint _vala_main (gchar** args, int args_length1) {
	...
	config = _tmp0_;
	_tmp1_ = tracker_icon_config_new_with_domain ("tracker-status-icon");
	_g_object_unref0 (icon_config);
	icon_config = _tmp1_;
	...
	_tmp4_ = _tmp3_;
	_tmp5_ = _g_object_ref0 (GTK_IS_WINDOW (_tmp4_) ? ((GtkWindow*) _tmp4_) : NULL);
	_g_object_unref0 (window);
	window = _tmp5_;
	_tmp6_ = gtk_builder_get_object (builder, "checkbutton_enable_index_on_battery");
	_tmp7_ = _tmp6_;
	_tmp8_ = _g_object_ref0 (GTK_IS_CHECK_BUTTON (_tmp7_) ? ((GtkCheckButton*) _tmp7_) : NULL);
	_g_object_unref0 (checkbutton_enable_index_on_battery);
	checkbutton_enable_index_on_battery = _tmp8_;
	_tmp9_ = gtk_builder_get_object (builder, "checkbutton_enable_index_on_battery_first_time");
	_tmp10_ = _tmp9_;
	...
	checkbutton_enable_index_on_battery_first_time = _tmp11_;
	_tmp12_ = tracker_config_get_index_on_battery (config);
	gtk_toggle_button_set_active ((GtkToggleButton*) checkbutton_enable_index_on_battery, _tmp12_);
	_tmp13_ = gtk_toggle_button_get_active ((GtkToggleButton*) checkbutton_enable_index_on_battery);
	gtk_widget_set_sensitive ((GtkWidget*) checkbutton_enable_index_on_battery_first_time, !_tmp13_);
	_tmp14_ = tracker_config_get_index_on_battery_first_time (config);
	gtk_toggle_button_set_active ((GtkToggleButton*) checkbutton_enable_index_on_battery_first_time, _tmp14_);
	...
	spinbutton_delay = _tmp17_;
	gtk_spin_button_set_increments (spinbutton_delay, (gdouble) 1, (gdouble) 1);
	_tmp18_ = tracker_config_get_initial_sleep (config);
	gtk_spin_button_set_value (spinbutton_delay, (gdouble) _tmp18_);
	_tmp19_ = gtk_builder_get_object (builder, "checkbutton_enable_monitoring");
	_tmp20_ = _tmp19_;
	...
	checkbutton_enable_monitoring = _tmp21_;
	_tmp22_ = tracker_config_get_enable_monitors (config);
	gtk_toggle_button_set_active ((GtkToggleButton*) checkbutton_enable_monitoring, _tmp22_);
	_tmp23_ = gtk_builder_get_object (builder, "checkbutton_index_removable_media");
	_tmp24_ = _tmp23_;
	...
	checkbutton_index_removable_media = _tmp25_;
	_tmp26_ = tracker_config_get_index_removable_devices (config);
	gtk_toggle_button_set_active ((GtkToggleButton*) checkbutton_index_removable_media, _tmp26_);
	_tmp27_ = gtk_builder_get_object (builder, "checkbutton_index_optical_discs");
	_tmp28_ = _tmp27_;
	_tmp29_ = _g_object_ref0 (GTK_IS_CHECK_BUTTON (_tmp28_) ? ((GtkCheckButton*) _tmp28_) : NULL);
	_g_object_unref0 (checkbutton_index_optical_discs);
	checkbutton_index_optical_discs = _tmp29_;
	_tmp30_ = gtk_toggle_button_get_active ((GtkToggleButton*) checkbutton_index_removable_media);
	gtk_widget_set_sensitive ((GtkWidget*) checkbutton_index_optical_discs, _tmp30_);
	_tmp31_ = tracker_config_get_index_optical_discs (config);
	gtk_toggle_button_set_active ((GtkToggleButton*) checkbutton_index_optical_discs, _tmp31_);
	_tmp32_ = gtk_builder_get_object (builder, "hscale_disk_space_limit");
	_tmp33_ = _tmp32_;
	_tmp34_ = _g_object_ref0 (GTK_IS_SCALE (_tmp33_) ? ((GtkScale*) _tmp33_) : NULL);
	_g_object_unref0 (hscale_disk_space_limit);
	hscale_disk_space_limit = _tmp34_;
	_tmp35_ = tracker_config_get_low_disk_space_limit (config);
	gtk_range_set_value ((GtkRange*) hscale_disk_space_limit, (gdouble) _tmp35_);
	_tmp36_ = gtk_builder_get_object (builder, "hscale_throttle");
	_tmp37_ = _tmp36_;
	_tmp38_ = _g_object_ref0 (GTK_IS_SCALE (_tmp37_) ? ((GtkScale*) _tmp37_) : NULL);
	_g_object_unref0 (hscale_throttle);
	hscale_throttle = _tmp38_;
	_tmp39_ = tracker_config_get_throttle (config);
	gtk_range_set_value ((GtkRange*) hscale_throttle, (gdouble) _tmp39_);
	_tmp40_ = gtk_builder_get_object (builder, "togglebutton_home");
	_tmp41_ = _tmp40_;
	_tmp42_ = _g_object_ref0 (GTK_IS_TOGGLE_BUTTON (_tmp41_) ? ((GtkToggleButton*) _tmp41_) : NULL);
	_g_object_unref0 (togglebutton_home);
	togglebutton_home = _tmp42_;
	_tmp43_ = gtk_builder_get_object (builder, "notebook");
	_tmp44_ = _tmp43_;
	_tmp45_ = _g_object_ref0 (GTK_IS_NOTEBOOK (_tmp44_) ? ((GtkNotebook*) _tmp44_) : NULL);
	_g_object_unref0 (notebook);
	notebook = _tmp45_;
	_tmp46_ = gtk_builder_get_object (builder, "radiobutton_display_never");
	_tmp47_ = _tmp46_;
	_tmp48_ = _g_object_ref0 (GTK_IS_RADIO_BUTTON (_tmp47_) ? ((GtkRadioButton*) _tmp47_) : NULL);
	_g_object_unref0 (radiobutton_display_never);
	radiobutton_display_never = _tmp48_;
	_tmp49_ = gtk_builder_get_object (builder, "radiobutton_display_active");
	_tmp50_ = _tmp49_;
	_tmp51_ = _g_object_ref0 (GTK_IS_RADIO_BUTTON (_tmp50_) ? ((GtkRadioButton*) _tmp50_) : NULL);
	_g_object_unref0 (radiobutton_display_active);
	radiobutton_display_active = _tmp51_;
	_tmp52_ = gtk_builder_get_object (builder, "radiobutton_display_always");
	_tmp53_ = _tmp52_;
	_tmp54_ = _g_object_ref0 (GTK_IS_RADIO_BUTTON (_tmp53_) ? ((GtkRadioButton*) _tmp53_) : NULL);
	_g_object_unref0 (radiobutton_display_always);
	radiobutton_display_always = _tmp54_;
	initialize_visibility_radiobutton ();
	if (!HAVE_TRACKER_STATUS_ICON) {
		gtk_notebook_remove_page (notebook, 0);
	}
	_tmp55_ = gtk_builder_get_object (builder, "treeview_index_recursively");
	_tmp56_ = _tmp55_;
	_tmp57_ = _g_object_ref0 (GTK_IS_TREE_VIEW (_tmp56_) ? ((GtkTreeView*) _tmp56_) : NULL);
	_g_object_unref0 (treeview_index_recursively);
	treeview_index_recursively = _tmp57_;
	_tmp58_ = gtk_builder_get_object (builder, "treeview_index_single");
	_tmp59_ = _tmp58_;
	_tmp60_ = _g_object_ref0 (GTK_IS_TREE_VIEW (_tmp59_) ? ((GtkTreeView*) _tmp59_) : NULL);
	_g_object_unref0 (treeview_index_single);
	treeview_index_single = _tmp60_;
	_tmp61_ = gtk_builder_get_object (builder, "treeview_ignored_directories");
	_tmp62_ = _tmp61_;
	_tmp63_ = _g_object_ref0 (GTK_IS_TREE_VIEW (_tmp62_) ? ((GtkTreeView*) _tmp62_) : NULL);
	_g_object_unref0 (treeview_ignored_directories);
	treeview_ignored_directories = _tmp63_;
	_tmp64_ = gtk_builder_get_object (builder, "treeview_ignored_directories_with_content");
	_tmp65_ = _tmp64_;
	_tmp66_ = _g_object_ref0 (GTK_IS_TREE_VIEW (_tmp65_) ? ((GtkTreeView*) _tmp65_) : NULL);
	_g_object_unref0 (treeview_ignored_directories_with_content);
	treeview_ignored_directories_with_content = _tmp66_;
	_tmp67_ = gtk_builder_get_object (builder, "treeview_ignored_files");
	_tmp68_ = _tmp67_;
	_tmp69_ = _g_object_ref0 (GTK_IS_TREE_VIEW (_tmp68_) ? ((GtkTreeView*) _tmp68_) : NULL);
	_g_object_unref0 (treeview_ignored_files);
	treeview_ignored_files = _tmp69_;
	_tmp70_ = _ ("Directory");
	setup_standard_treeview (treeview_index_recursively, _tmp70_);
	_tmp71_ = _ ("Directory");
	setup_standard_treeview (treeview_index_single, _tmp71_);
	_tmp72_ = _ ("Directory");
	setup_standard_treeview (treeview_ignored_directories, _tmp72_);
	_tmp73_ = _ ("Directory");
	setup_standard_treeview (treeview_ignored_directories_with_content, _tmp73_);
	_tmp74_ = _ ("File");
	setup_standard_treeview (treeview_ignored_files, _tmp74_);
	_tmp75_ = gtk_builder_get_object (builder, "liststore_index_recursively");
	_tmp76_ = _tmp75_;
	_tmp77_ = _g_object_ref0 (GTK_IS_LIST_STORE (_tmp76_) ? ((GtkListStore*) _tmp76_) : NULL);
	_g_object_unref0 (liststore_index_recursively);
	liststore_index_recursively = _tmp77_;
	_tmp78_ = tracker_config_get_index_recursive_directories_unfiltered (config);
	fill_in_model (liststore_index_recursively, _tmp78_);
	_tmp79_ = model_contains ((GtkTreeModel*) liststore_index_recursively, HOME_STRING);
	gtk_toggle_button_set_active (togglebutton_home, _tmp79_);
	_tmp80_ = gtk_builder_get_object (builder, "liststore_index_single");
	_tmp81_ = _tmp80_;
	_tmp82_ = _g_object_ref0 (GTK_IS_LIST_STORE (_tmp81_) ? ((GtkListStore*) _tmp81_) : NULL);
	_g_object_unref0 (liststore_index_single);
	liststore_index_single = _tmp82_;
	_tmp83_ = tracker_config_get_index_single_directories_unfiltered (config);
	fill_in_model (liststore_index_single, _tmp83_);
	_tmp84_ = gtk_builder_get_object (builder, "liststore_ignored_directories");
	_tmp85_ = _tmp84_;
	_tmp86_ = _g_object_ref0 (GTK_IS_LIST_STORE (_tmp85_) ? ((GtkListStore*) _tmp85_) : NULL);
	_g_object_unref0 (liststore_ignored_directories);
	liststore_ignored_directories = _tmp86_;
	_tmp87_ = tracker_config_get_ignored_directories (config);
	fill_in_model (liststore_ignored_directories, _tmp87_);
	_tmp88_ = gtk_builder_get_object (builder, "liststore_ignored_files");
	_tmp89_ = _tmp88_;
	_tmp90_ = _g_object_ref0 (GTK_IS_LIST_STORE (_tmp89_) ? ((GtkListStore*) _tmp89_) : NULL);
	_g_object_unref0 (liststore_ignored_files);
	liststore_ignored_files = _tmp90_;
	_tmp91_ = tracker_config_get_ignored_files (config);
	fill_in_model (liststore_ignored_files, _tmp91_);
	_tmp92_ = gtk_builder_get_object (builder, "liststore_gnored_directories_with_content");
	_tmp93_ = _tmp92_;
	_tmp94_ = _g_object_ref0 (GTK_IS_LIST_STORE (_tmp93_) ? ((GtkListStore*) _tmp93_) : NULL);
	_g_object_unref0 (liststore_gnored_directories_with_content);
	liststore_gnored_directories_with_content = _tmp94_;
	_tmp95_ = tracker_config_get_ignored_directories_with_content (config);
	fill_in_model (liststore_gnored_directories_with_content, _tmp95_);
