/* tracker-statistics.c generated by valac 0.11.4, the Vala compiler
...
GVariant* tracker_statistics_get (TrackerStatistics* self, const char* sender) {
	...
	request = _tmp0_;
	_tmp1_ = g_variant_builder_new ((GVariantType*) "aas");
	builder = _tmp1_;
	_tmp3_ = tracker_ontologies_get_classes (&_tmp2_);
	{
		...
		for (cl_it = 0; cl_it < _tmp2_; cl_it = cl_it + 1) {
			...
			cl = _tmp4_;
			{
				...
				g_variant_builder_open (builder, (GVariantType*) "as");
