/* tracker-status.c generated by valac 0.19.0.3-f335, the Vala compiler
...
static void _g_object_unref0_ (gpointer var) {
#line 36 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	(var == NULL) ? NULL : (var = (g_object_unref (var), NULL));
#line 178 "tracker-status.c"
}
...
static gboolean tracker_status_busy_notification_timeout (TrackerStatus* self) {
	...
	const gchar* _tmp0_;
	gdouble _tmp1_;
#line 57 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 59 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = self->priv->status;
#line 59 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	_tmp1_ = self->priv->_progress;
#line 59 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	g_signal_emit_by_name (self, "progress", _tmp0_, _tmp1_);
#line 61 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	self->priv->timer_id = (guint) 0;
#line 63 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	result = FALSE;
#line 63 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	return result;
#line 209 "tracker-status.c"
}


static gpointer _g_object_ref0 (gpointer self) {
#line 75 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
...
#line 88 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	return result;
#line 225 "tracker-status.c"
}
...
static void tracker_status_callback (TrackerStatus* self, const gchar* status, gdouble progress) {
	...
	const gchar* _tmp10_;
	guint _tmp13_;
#line 68 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	g_return_if_fail (self != NULL);
#line 68 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	g_return_if_fail (status != NULL);
#line 69 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = progress;
#line 69 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	self->priv->_progress = _tmp0_;
#line 71 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	_tmp2_ = progress;
#line 71 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	if (_tmp2_ == ((gdouble) 1)) {
#line 249 "tracker-status.c"
		GList* _tmp3_;
#line 71 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
...
#line 265 "tracker-status.c"
		GList* _tmp5_;
#line 74 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		self->priv->wait_list = g_list_reverse (self->priv->wait_list);
#line 75 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		_tmp5_ = self->priv->wait_list;
#line 271 "tracker-status.c"
		{
			GList* context_collection = NULL;
			GList* context_it = NULL;
#line 75 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
			context_collection = _tmp5_;
#line 75 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
			for (context_it = context_collection; context_it != NULL; context_it = context_it->next) {
#line 279 "tracker-status.c"
				TrackerStatusWaitContext* _tmp6_;
				TrackerStatusWaitContext* context = NULL;
#line 75 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
				_tmp6_ = _g_object_ref0 ((TrackerStatusWaitContext*) context_it->data);
#line 75 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
				context = _tmp6_;
#line 286 "tracker-status.c"
				{
					TrackerStatusWaitContext* _tmp7_;
					GSourceFunc _tmp8_;
					void* _tmp8__target;
#line 76 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
					_tmp7_ = context;
#line 76 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
...
#line 301 "tracker-status.c"
				}
			}
		}
#line 79 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		__g_list_free__g_object_unref0_0 (self->priv->wait_list);
#line 79 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		self->priv->wait_list = NULL;
#line 309 "tracker-status.c"
	}
#line 82 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	_tmp9_ = status;
#line 82 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	_tmp10_ = self->priv->status;
#line 82 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	if (g_strcmp0 (_tmp9_, _tmp10_) != 0) {
#line 317 "tracker-status.c"
		const gchar* _tmp11_;
		gchar* _tmp12_;
#line 83 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		_tmp11_ = status;
#line 83 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
...
#line 328 "tracker-status.c"
	}
#line 86 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	_tmp13_ = self->priv->timer_id;
#line 86 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	if (_tmp13_ == ((guint) 0)) {
#line 334 "tracker-status.c"
		gboolean _tmp14_;
#line 87 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		_tmp14_ = tracker_status_first_time;
#line 87 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		if (_tmp14_) {
#line 340 "tracker-status.c"
			guint _tmp15_ = 0U;
#line 88 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
			_tmp15_ = g_idle_add_full (G_PRIORITY_DEFAULT_IDLE, _tracker_status_busy_notification_timeout_gsource_func, g_object_ref (self), g_object_unref);
#line 88 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
			self->priv->timer_id = _tmp15_;
#line 89 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
			tracker_status_first_time = FALSE;
#line 348 "tracker-status.c"
		} else {
			guint _tmp16_ = 0U;
#line 91 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
			_tmp16_ = g_timeout_add_seconds_full (G_PRIORITY_DEFAULT, (guint) TRACKER_STATUS_PROGRESS_TIMEOUT_S, _tracker_status_busy_notification_timeout_gsource_func, g_object_ref (self), g_object_unref);
#line 91 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
			self->priv->timer_id = _tmp16_;
#line 355 "tracker-status.c"
		}
	}
#line 95 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	while (TRUE) {
#line 360 "tracker-status.c"
		GMainContext* _tmp17_ = NULL;
		gboolean _tmp18_ = FALSE;
#line 95 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		_tmp17_ = g_main_context_default ();
#line 95 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		_tmp18_ = g_main_context_iteration (_tmp17_, FALSE);
#line 95 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		if (!_tmp18_) {
#line 95 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
			break;
#line 371 "tracker-status.c"
		}
	}
}
...
static void _tracker_status_callback_tracker_busy_callback (const gchar* status, gdouble progress, gpointer self) {
#line 101 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	tracker_status_callback (self, status, progress);
#line 380 "tracker-status.c"
}
...
#line 100 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
...
gdouble tracker_status_get_progress (TrackerStatus* self) {
	gdouble result = 0.0;
	gdouble _tmp0_;
#line 104 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	g_return_val_if_fail (self != NULL, 0.0);
#line 105 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
...
gchar* tracker_status_get_status (TrackerStatus* self) {
	...
	const gchar* _tmp0_;
	gchar* _tmp1_;
#line 108 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 109 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = self->priv->status;
#line 109 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
...
static void tracker_status_wait_data_free (gpointer _data) {
	...
	_data_ = _data;
#line 24 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	_g_object_unref0 (_data_->self);
#line 24 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	g_slice_free (TrackerStatusWaitData, _data_);
#line 449 "tracker-status.c"
}
...
#line 117 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	return result;
#line 491 "tracker-status.c"
}


static gboolean tracker_status_wait_co (TrackerStatusWaitData* _data_) {
#line 112 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	switch (_data_->_state_) {
#line 112 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		case 0:
#line 500 "tracker-status.c"
		goto _state_0;
#line 112 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		case 1:
#line 504 "tracker-status.c"
		goto _state_1;
		default:
#line 112 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		g_assert_not_reached ();
#line 509 "tracker-status.c"
	}
	_state_0:
#line 113 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	_data_->_tmp0_ = _data_->self->priv->_progress;
#line 113 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	if (_data_->_tmp0_ == ((gdouble) 1)) {
#line 516 "tracker-status.c"
	} else {
#line 116 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
...
#line 117 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		_data_->_tmp2_->callback_target_destroy_notify = NULL;
#line 118 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
...
#line 119 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		_data_->_state_ = 1;
#line 119 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		return FALSE;
#line 548 "tracker-status.c"
		_state_1:
		;
#line 113 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
...
#line 605 "tracker-status.c"
	} else {
#line 24 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		data1 = param_values->data[0].v_pointer;
#line 24 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		data2 = closure->data;
#line 611 "tracker-status.c"
	}
#line 24 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
...
#line 617 "tracker-status.c"
}


static TrackerStatusWaitContext* tracker_status_wait_context_construct (GType object_type) {
	TrackerStatusWaitContext * self = NULL;
#line 29 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	self = (TrackerStatusWaitContext*) g_object_new (object_type, NULL);
#line 29 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	return self;
#line 627 "tracker-status.c"
}
...
#line 30 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
...
#line 34 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = g_strdup ("Idle");
#line 34 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	self->priv->status = _tmp0_;
#line 714 "tracker-status.c"
}
...
#line 52 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = self->priv->timer_id;
#line 52 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	if (_tmp0_ != ((guint) 0)) {
#line 727 "tracker-status.c"
		guint _tmp1_;
#line 53 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		_tmp1_ = self->priv->timer_id;
#line 53 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
		g_source_remove (_tmp1_);
#line 733 "tracker-status.c"
	}
#line 34 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
	_g_free0 (self->priv->status);
#line 36 "/home/martyn/Source/checkout/gnome/tracker/src/tracker-store/tracker-status.vala"
