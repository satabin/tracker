/* tracker-status.c generated by valac 0.22.1, the Vala compiler
...
static void _g_object_unref0_ (gpointer var) {
#line 36 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
static gboolean tracker_status_busy_notification_timeout (TrackerStatus* self) {
	...
	gdouble _tmp1_ = 0.0;
#line 57 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 59 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = self->priv->status;
#line 59 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	_tmp1_ = self->priv->_progress;
#line 59 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	g_signal_emit_by_name (self, "progress", _tmp0_, _tmp1_);
#line 61 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	self->priv->timer_id = (guint) 0;
#line 63 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	result = FALSE;
#line 63 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	return result;
...
#line 75 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
#line 88 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	return result;
...
static void tracker_status_callback (TrackerStatus* self, const gchar* status, gdouble progress) {
	...
	guint _tmp13_ = 0U;
#line 68 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	g_return_if_fail (self != NULL);
#line 68 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	g_return_if_fail (status != NULL);
#line 69 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = progress;
#line 69 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	self->priv->_progress = _tmp0_;
#line 71 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	_tmp2_ = progress;
#line 71 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	if (_tmp2_ == ((gdouble) 1)) {
...
#line 265 "tracker-status.c"
		GList* _tmp5_ = NULL;
#line 74 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
#line 286 "tracker-status.c"
				{
					TrackerStatusWaitContext* _tmp7_ = NULL;
					GSourceFunc _tmp8_ = NULL;
					void* _tmp8__target = NULL;
#line 76 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
					_tmp7_ = context;
#line 76 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
#line 79 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
		__g_list_free__g_object_unref0_0 (self->priv->wait_list);
#line 79 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
		self->priv->wait_list = NULL;
#line 309 "tracker-status.c"
	}
#line 82 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	_tmp9_ = status;
#line 82 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
#line 317 "tracker-status.c"
		...
		gchar* _tmp12_ = NULL;
#line 83 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
		_tmp11_ = status;
#line 83 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
#line 86 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	_tmp13_ = self->priv->timer_id;
#line 86 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	if (_tmp13_ == ((guint) 0)) {
#line 334 "tracker-status.c"
		gboolean _tmp14_ = FALSE;
#line 87 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
#line 89 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
			tracker_status_first_time = FALSE;
#line 348 "tracker-status.c"
		} else {
			guint _tmp16_ = 0U;
#line 91 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
#line 95 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	while (TRUE) {
...
static void _tracker_status_callback_tracker_busy_callback (const gchar* status, gdouble progress, gpointer self) {
#line 101 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
#line 100 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
gdouble tracker_status_get_progress (TrackerStatus* self) {
	gdouble result = 0.0;
	gdouble _tmp0_ = 0.0;
#line 104 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	g_return_val_if_fail (self != NULL, 0.0);
#line 105 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
gchar* tracker_status_get_status (TrackerStatus* self) {
	...
	const gchar* _tmp0_ = NULL;
	gchar* _tmp1_ = NULL;
#line 108 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 109 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = self->priv->status;
#line 109 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
static void tracker_status_wait_data_free (gpointer _data) {
	...
	_data_ = _data;
#line 24 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
#line 117 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	return result;
...
static gboolean tracker_status_wait_co (TrackerStatusWaitData* _data_) {
#line 112 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
#line 509 "tracker-status.c"
	...
	_state_0:
#line 113 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	_data_->_tmp0_ = 0.0;
#line 113 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	_data_->_tmp0_ = _data_->self->priv->_progress;
#line 113 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	if (_data_->_tmp0_ == ((gdouble) 1)) {
#line 518 "tracker-status.c"
	} else {
#line 116 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
		_data_->_tmp1_ = NULL;
#line 116 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
#line 117 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
		_data_->_tmp2_->callback_target_destroy_notify = NULL;
#line 118 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
		_data_->_tmp3_ = NULL;
#line 118 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
#line 119 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
		_data_->_state_ = 1;
#line 119 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
		return FALSE;
#line 558 "tracker-status.c"
		_state_1:
		;
#line 113 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
#line 29 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	self = (TrackerStatusWaitContext*) g_object_new (object_type, NULL);
#line 29 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	return self;
#line 637 "tracker-status.c"
}
...
#line 30 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
...
#line 34 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = g_strdup ("Idle");
#line 34 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	self->priv->status = _tmp0_;
#line 724 "tracker-status.c"
}
...
#line 52 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = self->priv->timer_id;
#line 52 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
	if (_tmp0_ != ((guint) 0)) {
#line 737 "tracker-status.c"
		guint _tmp1_ = 0U;
#line 53 "/home/martyn/Source/tracker/src/tracker-store/tracker-status.vala"
