/* tracker-status.c generated by valac 0.14.0, the Vala compiler
...
static void _g_object_unref0_ (gpointer var) {
#line 36 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
static gboolean tracker_status_busy_notification_timeout (TrackerStatus* self) {
	...
	const gchar* _tmp0_;
	gdouble _tmp1_;
#line 57 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 59 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = self->priv->status;
#line 59 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	_tmp1_ = self->priv->_progress;
#line 59 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	g_signal_emit_by_name (self, "progress", _tmp0_, _tmp1_);
#line 61 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	self->priv->timer_id = (guint) 0;
#line 63 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	result = FALSE;
#line 63 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	return result;
...
#line 75 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
#line 88 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	return result;
...
static void tracker_status_callback (TrackerStatus* self, const gchar* status, gdouble progress) {
	...
	const gchar* _tmp10_;
	guint _tmp13_;
#line 68 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	g_return_if_fail (self != NULL);
#line 68 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	g_return_if_fail (status != NULL);
#line 69 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = progress;
#line 69 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	self->priv->_progress = _tmp0_;
#line 71 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	_tmp2_ = progress;
#line 71 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	if (_tmp2_ == ((gdouble) 1)) {
...
#line 265 "tracker-status.c"
		GList* _tmp5_;
#line 74 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
#line 286 "tracker-status.c"
				{
					...
					GSourceFunc _tmp8_;
					void* _tmp8__target;
#line 76 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
					_tmp7_ = context;
#line 76 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
#line 79 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
		__g_list_free__g_object_unref0_0 (self->priv->wait_list);
#line 79 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
		self->priv->wait_list = NULL;
#line 309 "tracker-status.c"
	}
#line 82 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	_tmp9_ = status;
#line 82 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
#line 317 "tracker-status.c"
		const gchar* _tmp11_;
		gchar* _tmp12_;
#line 83 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
		_tmp11_ = status;
#line 83 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
#line 86 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	_tmp13_ = self->priv->timer_id;
#line 86 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	if (_tmp13_ == ((guint) 0)) {
#line 334 "tracker-status.c"
		gboolean _tmp14_;
#line 87 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
#line 89 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
			tracker_status_first_time = FALSE;
#line 348 "tracker-status.c"
		} else {
			guint _tmp16_ = 0U;
#line 91 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
#line 95 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	while (TRUE) {
...
static void _tracker_status_callback_tracker_busy_callback (const gchar* status, gdouble progress, gpointer self) {
#line 101 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
#line 100 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
gdouble tracker_status_get_progress (TrackerStatus* self) {
	gdouble result = 0.0;
	gdouble _tmp0_;
#line 104 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	g_return_val_if_fail (self != NULL, 0.0);
#line 105 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
gchar* tracker_status_get_status (TrackerStatus* self) {
	...
	const gchar* _tmp0_;
	gchar* _tmp1_;
#line 108 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 109 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = self->priv->status;
#line 109 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
static void tracker_status_wait_data_free (gpointer _data) {
	...
	_data_ = _data;
#line 24 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
#line 117 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	return result;
...
static gboolean tracker_status_wait_co (TrackerStatusWaitData* _data_) {
#line 112 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
#line 509 "tracker-status.c"
	...
	_state_0:
#line 113 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	_data_->_tmp0_ = _data_->self->priv->_progress;
#line 113 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	if (_data_->_tmp0_ == ((gdouble) 1)) {
#line 516 "tracker-status.c"
	} else {
#line 116 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
#line 117 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
		_data_->_tmp2_->callback_target_destroy_notify = NULL;
#line 118 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
#line 119 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
		_data_->_state_ = 1;
#line 119 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
		return FALSE;
...
#line 29 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
#line 30 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
#line 34 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
...
#line 52 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	_tmp0_ = self->priv->timer_id;
#line 52 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
	if (_tmp0_ != ((guint) 0)) {
#line 727 "tracker-status.c"
		guint _tmp1_;
#line 53 "/home/juerg/Code/tracker/tracker/src/tracker-store/tracker-status.vala"
