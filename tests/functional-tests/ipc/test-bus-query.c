/* test-bus-query.c generated by valac 0.24.0.131-42e78, the Vala compiler
...
gint _vala_main (gchar** args, int args_length1) {
	...
	GError * _inner_error_ = NULL;
	{
		...
		TrackerBusConnection* _tmp1_ = NULL;
		TestApp* app = NULL;
		TestApp* _tmp2_ = NULL;
		TestApp* _tmp3_ = NULL;
		gint _tmp4_ = 0;
#line 8 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-bus-query.vala"
		_tmp1_ = tracker_bus_connection_new (&_inner_error_);
#line 8 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-bus-query.vala"
		_tmp0_ = _tmp1_;
#line 8 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-bus-query.vala"
		if (G_UNLIKELY (_inner_error_ != NULL)) {
#line 51 "test-bus-query.c"
...
#line 8 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-bus-query.vala"
		app = _tmp2_;
#line 10 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-bus-query.vala"
		_tmp3_ = app;
#line 10 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-bus-query.vala"
...
#line 7 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-bus-query.vala"
		e = _inner_error_;
#line 7 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-bus-query.vala"
		_inner_error_ = NULL;
#line 12 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-bus-query.vala"
		_tmp5_ = e;
#line 12 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-bus-query.vala"
		_tmp6_ = _tmp5_->message;
#line 12 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-bus-query.vala"
		g_warning ("test-bus-query.vala:12: Couldn't perform test: %s", _tmp6_);
#line 13 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-bus-query.vala"
		result = 1;
#line 13 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-bus-query.vala"
		_g_error_free0 (e);
#line 13 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-bus-query.vala"
...
int main (int argc, char ** argv) {
	...
	g_type_init ();
#endif
#line 4 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-bus-query.vala"
	return _vala_main (argv, argc);
#line 113 "test-bus-query.c"
}
