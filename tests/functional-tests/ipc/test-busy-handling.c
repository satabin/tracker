/* test-busy-handling.c generated by valac 0.19.0.3-f335, the Vala compiler
...
void resources_sparql_query (Resources* self, const gchar* query, GAsyncReadyCallback _callback_, gpointer _user_data_) {
#line 30 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	RESOURCES_GET_INTERFACE (self)->sparql_query (self, query, _callback_, _user_data_);
#line 281 "test-busy-handling.c"
}
...
gdouble status_get_progress (Status* self, GError** error) {
#line 38 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_return_val_if_fail (self != NULL, 0.0);
#line 38 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return STATUS_GET_INTERFACE (self)->get_progress (self, error);
#line 538 "test-busy-handling.c"
}


gchar* status_get_status (Status* self, GError** error) {
#line 39 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 39 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return STATUS_GET_INTERFACE (self)->get_status (self, error);
#line 547 "test-busy-handling.c"
}
...
#line 36 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 566 "test-busy-handling.c"
	} else {
#line 36 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		data1 = param_values->data[0].v_pointer;
#line 36 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		data2 = closure->data;
#line 572 "test-busy-handling.c"
	}
#line 36 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
static void _test_app_on_status_cb_status_progress (Status* _sender, const gchar* status, gdouble progress, gpointer self) {
#line 67 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_on_status_cb (self, status, progress);
#line 846 "test-busy-handling.c"
}
...
#line 51 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self = (TestApp*) g_type_create_instance (object_type);
#line 51 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp0_ = self->priv->initialized;
#line 51 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_return_val_if_fail (!_tmp0_, NULL);
#line 860 "test-busy-handling.c"
	{
		gdouble progress = 0.0;
		gchar* status = NULL;
...
#line 62 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 62 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
			_g_free0 (status);
#line 901 "test-busy-handling.c"
			goto __catch0_g_error;
		}
#line 62 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_g_object_unref0 (test_app_status_object);
#line 62 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		test_app_status_object = _tmp4_;
#line 67 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp5_ = test_app_status_object;
#line 67 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_signal_connect (_tmp5_, "progress", (GCallback) _test_app_on_status_cb_status_progress, self);
#line 68 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp6_ = test_app_status_object;
#line 68 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp7_ = status_get_progress (_tmp6_, &_inner_error_);
#line 68 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp8_ = _tmp7_;
#line 68 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		if (_inner_error_ != NULL) {
#line 68 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
			_g_free0 (status);
#line 922 "test-busy-handling.c"
			goto __catch0_g_error;
		}
#line 68 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		progress = _tmp8_;
#line 69 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp9_ = test_app_status_object;
#line 69 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp10_ = status_get_status (_tmp9_, &_inner_error_);
#line 69 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp11_ = _tmp10_;
#line 69 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		if (_inner_error_ != NULL) {
...
#line 69 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		status = _tmp11_;
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp13_ = progress;
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		if (_tmp13_ == 1.0) {
#line 948 "test-busy-handling.c"
			const gchar* _tmp14_;
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
			_tmp14_ = status;
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
			_tmp12_ = g_strcmp0 (_tmp14_, "Idle") == 0;
#line 954 "test-busy-handling.c"
		} else {
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
			_tmp12_ = FALSE;
#line 958 "test-busy-handling.c"
		}
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp15_ = _tmp12_;
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		self->priv->ready = _tmp15_;
#line 53 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_g_free0 (status);
#line 966 "test-busy-handling.c"
	}
	goto __finally0;
	__catch0_g_error:
	{
...
#line 53 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_inner_error_ = NULL;
#line 74 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp16_ = e;
#line 74 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp17_ = _tmp16_->message;
#line 74 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_warning ("test-busy-handling.vala:74: Could not connect to D-Bus service: %s", _tmp17_);
#line 75 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		self->priv->initialized = FALSE;
#line 76 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		self->priv->res = -1;
#line 77 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_g_error_free0 (e);
#line 77 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		return self;
#line 992 "test-busy-handling.c"
	}
	__finally0:
#line 53 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (_inner_error_ != NULL) {
...
#line 53 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		return NULL;
#line 1003 "test-busy-handling.c"
	}
#line 79 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1016 "test-busy-handling.c"
}
...
static void test_app_on_status_cb (TestApp* self, const gchar* status, gdouble progress) {
	...
	gdouble _tmp1_;
	gdouble _tmp2_;
#line 82 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_return_if_fail (self != NULL);
#line 82 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_return_if_fail (status != NULL);
#line 83 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp0_ = status;
#line 83 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp1_ = progress;
#line 83 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_print ("%s: %f\n", _tmp0_, _tmp1_);
#line 85 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp2_ = progress;
#line 85 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (_tmp2_ == 1.0) {
#line 86 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		self->priv->ready = TRUE;
#line 1040 "test-busy-handling.c"
	}
}
...
static void test_app_do_query_tests_async_data_free (gpointer _data) {
	...
	_data_ = _data;
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1090 "test-busy-handling.c"
}
...
#line 1098 "test-busy-handling.c"
}


static void test_app_do_query_tests_async_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	TestAppDoQueryTestsAsyncData* _data_;
#line 93 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_ = _user_data_;
#line 93 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 93 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_do_query_tests_async_co (_data_);
#line 1112 "test-busy-handling.c"
}


static gboolean test_app_do_query_tests_async_co (TestAppDoQueryTestsAsyncData* _data_) {
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	switch (_data_->_state_) {
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 0:
#line 1121 "test-busy-handling.c"
		goto _state_0;
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 1:
#line 1125 "test-busy-handling.c"
		goto _state_1;
		default:
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_assert_not_reached ();
#line 1130 "test-busy-handling.c"
	}
	_state_0:
	{
#line 92 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_data_->cnt = 0;
#line 93 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 93 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		return FALSE;
#line 1148 "test-busy-handling.c"
		_state_1:
#line 93 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_data_->_tmp3_ = NULL;
#line 93 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1162 "test-busy-handling.c"
			goto __catch1_g_error;
		}
		{
#line 94 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1180 "test-busy-handling.c"
				{
#line 95 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
					_data_->_tmp5_ = _data_->cnt;
#line 95 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
					_data_->cnt = _data_->_tmp5_ + 1;
#line 94 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
					_g_free0 (_data_->res);
#line 1188 "test-busy-handling.c"
				}
			}
		}
#line 97 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_data_->_tmp6_ = _data_->test_name;
#line 97 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_data_->_tmp7_ = _data_->cnt;
#line 97 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_print ("%s: Saw %d strings in result\n", _data_->_tmp6_, _data_->_tmp7_);
#line 91 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_data_->results = (_vala_array_free (_data_->results, _data_->results_length1 * _data_->results_length2, (GDestroyNotify) g_free), NULL);
#line 1200 "test-busy-handling.c"
	}
	goto __finally1;
	__catch1_g_error:
	{
...
#line 99 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_data_->_tmp8_ = _data_->e;
#line 99 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_data_->_tmp9_ = _data_->_tmp8_->message;
#line 99 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_print ("Fail: %s\n", _data_->_tmp9_);
#line 100 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 91 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		return FALSE;
#line 1230 "test-busy-handling.c"
	}
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (_data_->_state_ == 0) {
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_simple_async_result_complete_in_idle (_data_->_async_result);
#line 1236 "test-busy-handling.c"
	} else {
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return FALSE;
#line 1246 "test-busy-handling.c"
}
...
static void test_app_check_shutdown (TestApp* self) {
	gint _tmp0_;
	gint _tmp1_;
#line 104 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_return_if_fail (self != NULL);
#line 105 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp0_ = self->priv->users;
#line 105 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self->priv->users = _tmp0_ - 1;
#line 106 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp1_ = self->priv->users;
#line 106 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (_tmp1_ == 0) {
#line 1263 "test-busy-handling.c"
		GMainLoop* _tmp2_;
#line 107 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_print ("Async tests done, now I can quit the mainloop\n");
#line 108 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1283 "test-busy-handling.c"
}
...
#line 1302 "test-busy-handling.c"
}
...
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_ = g_simple_async_result_get_op_res_gpointer (G_SIMPLE_ASYNC_RESULT (_res_));
#line 1310 "test-busy-handling.c"
}


static void test_app_do_async_query_tests_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	TestAppDoAsyncQueryTestsData* _data_;
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_ = _user_data_;
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_->_source_object_ = source_object;
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_do_async_query_tests_co (_data_);
#line 1324 "test-busy-handling.c"
}


static gboolean test_app_do_async_query_tests_co (TestAppDoAsyncQueryTestsData* _data_) {
#line 112 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	switch (_data_->_state_) {
#line 112 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 0:
#line 1333 "test-busy-handling.c"
		goto _state_0;
#line 112 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 1:
#line 1337 "test-busy-handling.c"
		goto _state_1;
		default:
#line 112 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_assert_not_reached ();
#line 1342 "test-busy-handling.c"
	...
	_state_0:
#line 113 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_print ("Test 1: Just launch the query and let it wait\n" \
"Test 1: query launches immediately\n");
#line 114 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return FALSE;
#line 1357 "test-busy-handling.c"
	_state_1:
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_do_query_tests_finish (_data_->self, _data_->_res_);
#line 117 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_check_shutdown (_data_->self);
#line 112 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (_data_->_state_ == 0) {
#line 112 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_simple_async_result_complete_in_idle (_data_->_async_result);
#line 1367 "test-busy-handling.c"
	} else {
#line 112 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_simple_async_result_complete (_data_->_async_result);
#line 1371 "test-busy-handling.c"
	}
#line 112 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_object_unref (_data_->_async_result);
#line 112 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1407 "test-busy-handling.c"
}
...
static void test_app_jumper_async_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	TestAppJumperAsyncData* _data_;
#line 121 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_ = _user_data_;
#line 121 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_->_source_object_ = source_object;
#line 121 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
static gboolean test_app_jumper_async_co (TestAppJumperAsyncData* _data_) {
#line 120 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	switch (_data_->_state_) {
#line 120 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 0:
#line 1438 "test-busy-handling.c"
		goto _state_0;
#line 120 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 1:
...
#line 120 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_assert_not_reached ();
#line 1447 "test-busy-handling.c"
	}
	_state_0:
#line 121 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_->_state_ = 1;
...
#line 121 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_do_query_tests_finish (_data_->self, _data_->_res_);
#line 122 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_check_shutdown (_data_->self);
#line 120 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (_data_->_state_ == 0) {
#line 120 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_simple_async_result_complete_in_idle (_data_->_async_result);
#line 1466 "test-busy-handling.c"
	} else {
#line 120 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_simple_async_result_complete (_data_->_async_result);
...
#line 120 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return FALSE;
#line 1476 "test-busy-handling.c"
}
...
static gboolean test_app_test_ready (TestApp* self) {
	...
	gboolean _tmp0_;
	gboolean _tmp1_;
#line 125 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 127 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp0_ = self->priv->ready;
#line 127 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (_tmp0_) {
#line 128 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_print ("Test 2: query launches now\n");
#line 129 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		test_app_jumper_async (self, NULL, NULL);
#line 1494 "test-busy-handling.c"
	}
#line 132 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp1_ = self->priv->ready;
#line 132 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	result = !_tmp1_;
#line 132 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1502 "test-busy-handling.c"
}
...
#line 142 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
...
static gboolean test_app_in_mainloop (TestApp* self) {
	...
	gint _tmp0_;
	gboolean _tmp1_;
#line 135 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 136 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_do_async_query_tests (self, NULL, NULL);
#line 138 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_print ("Test 2: Wait for the status signal to indicate readyness\n");
#line 139 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp0_ = self->priv->users;
#line 139 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self->priv->users = _tmp0_ + 1;
#line 141 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp1_ = self->priv->ready;
#line 141 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (!_tmp1_) {
#line 142 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_timeout_add_full (G_PRIORITY_DEFAULT, (guint) 1, _test_app_test_ready_gsource_func, test_app_ref (self), test_app_unref);
#line 1535 "test-busy-handling.c"
	} else {
#line 144 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		test_app_test_ready (self);
#line 1539 "test-busy-handling.c"
	}
#line 147 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	result = FALSE;
#line 147 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1545 "test-busy-handling.c"
}
...
#line 153 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1554 "test-busy-handling.c"
}
...
gint test_app_run (TestApp* self) {
	...
	GMainLoop* _tmp1_;
	gint _tmp2_;
#line 150 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_return_val_if_fail (self != NULL, 0);
#line 151 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 155 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp1_ = self->priv->loop;
#line 155 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_main_loop_run (_tmp1_);
#line 157 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1613 "test-busy-handling.c"
	}
}
...
#line 1621 "test-busy-handling.c"
}
...
#line 1628 "test-busy-handling.c"
		TestApp* object;
...
#line 1635 "test-busy-handling.c"
		} else if (!g_value_type_compatible (G_TYPE_FROM_INSTANCE (object), G_VALUE_TYPE (value))) {
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
			return g_strconcat ("invalid object type `", g_type_name (G_TYPE_FROM_INSTANCE (object)), "' for value type `", G_VALUE_TYPE_NAME (value), "'", NULL);
#line 1639 "test-busy-handling.c"
		}
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		value->data[0].v_pointer = NULL;
#line 1647 "test-busy-handling.c"
	}
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return NULL;
...
#line 1662 "test-busy-handling.c"
	}
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (!value->data[0].v_pointer) {
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		*object_p = NULL;
#line 1668 "test-busy-handling.c"
...
#line 1676 "test-busy-handling.c"
	}
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return NULL;
#line 1680 "test-busy-handling.c"
}
...
#line 1723 "test-busy-handling.c"
	} else {
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		value->data[0].v_pointer = NULL;
#line 1727 "test-busy-handling.c"
	}
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (old) {
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		test_app_unref (old);
#line 1733 "test-busy-handling.c"
	}
}
...
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		value->data[0].v_pointer = NULL;
#line 1756 "test-busy-handling.c"
	}
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (old) {
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		test_app_unref (old);
#line 1762 "test-busy-handling.c"
	}
}
...
#line 1774 "test-busy-handling.c"
}
...
#line 45 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self->priv->res = -1;
#line 46 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self->priv->users = 0;
#line 48 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self->priv->initialized = FALSE;
#line 49 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self->priv->ready = FALSE;
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self->ref_count = 1;
#line 1791 "test-busy-handling.c"
}
...
#line 47 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_g_main_loop_unref0 (self->priv->loop);
#line 1801 "test-busy-handling.c"
}
...
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return instance;
#line 1826 "test-busy-handling.c"
}
...
#line 1839 "test-busy-handling.c"
	}
}
...
gint _vala_main (gchar** args, int args_length1) {
	...
	TestApp* app;
	gint _tmp1_ = 0;
#line 162 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp0_ = test_app_new ();
#line 162 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	app = _tmp0_;
#line 164 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 164 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1861 "test-busy-handling.c"
}


int main (int argc, char ** argv) {
#line 161 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_type_init ();
#line 161 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
