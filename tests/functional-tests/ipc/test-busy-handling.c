/* test-busy-handling.c generated by valac 0.16.1, the Vala compiler
...
#line 94 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
					_g_free0 (_data_->res);
#line 1186 "test-busy-handling.c"
				}
			}
		}
...
#line 1238 "test-busy-handling.c"
	}
#line 90 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 106 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (_tmp1_ == 0) {
#line 1261 "test-busy-handling.c"
		GMainLoop* _tmp2_;
...
#line 1300 "test-busy-handling.c"
}
...
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_ = g_simple_async_result_get_op_res_gpointer (G_SIMPLE_ASYNC_RESULT (_res_));
#line 1308 "test-busy-handling.c"
}
...
#line 115 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_do_async_query_tests_co (_data_);
#line 1322 "test-busy-handling.c"
}
...
#line 112 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_simple_async_result_complete_in_idle (_data_->_async_result);
#line 1365 "test-busy-handling.c"
	} else {
#line 112 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_simple_async_result_complete (_data_->_async_result);
#line 1369 "test-busy-handling.c"
	}
#line 112 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_object_unref (_data_->_async_result);
#line 112 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1386 "test-busy-handling.c"
}
...
#line 120 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 1:
#line 1440 "test-busy-handling.c"
		goto _state_1;
		default:
#line 120 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_assert_not_reached ();
#line 1445 "test-busy-handling.c"
	}
	_state_0:
#line 121 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_->_state_ = 1;
...
#line 120 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_simple_async_result_complete_in_idle (_data_->_async_result);
#line 1464 "test-busy-handling.c"
	} else {
#line 120 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_simple_async_result_complete (_data_->_async_result);
#line 1468 "test-busy-handling.c"
	}
#line 120 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_object_unref (_data_->_async_result);
#line 120 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 132 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1500 "test-busy-handling.c"
}
...
#line 142 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1509 "test-busy-handling.c"
}
...
#line 1533 "test-busy-handling.c"
	} else {
...
#line 147 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1543 "test-busy-handling.c"
}
...
#line 1588 "test-busy-handling.c"
}
...
#line 1597 "test-busy-handling.c"
	}
}
...
#line 1607 "test-busy-handling.c"
	} else {
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		dest_value->data[0].v_pointer = NULL;
#line 1611 "test-busy-handling.c"
	}
}
...
#line 1626 "test-busy-handling.c"
		TestApp* object;
...
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		value->data[0].v_pointer = NULL;
#line 1645 "test-busy-handling.c"
	}
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return NULL;
...
#line 1660 "test-busy-handling.c"
	}
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (!value->data[0].v_pointer) {
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		*object_p = NULL;
#line 1666 "test-busy-handling.c"
...
#line 1674 "test-busy-handling.c"
	}
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return NULL;
...
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		value->data[0].v_pointer = NULL;
#line 1725 "test-busy-handling.c"
	}
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (old) {
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		test_app_unref (old);
#line 1731 "test-busy-handling.c"
	}
}
...
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		value->data[0].v_pointer = v_object;
#line 1750 "test-busy-handling.c"
	} else {
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		value->data[0].v_pointer = NULL;
#line 1754 "test-busy-handling.c"
	}
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (old) {
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		test_app_unref (old);
#line 1760 "test-busy-handling.c"
	}
}
...
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self->ref_count = 1;
#line 1789 "test-busy-handling.c"
}
...
#line 47 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_g_main_loop_unref0 (self->priv->loop);
#line 1799 "test-busy-handling.c"
}
...
#line 1837 "test-busy-handling.c"
	}
}
