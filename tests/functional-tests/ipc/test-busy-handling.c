/* test-busy-handling.c generated by valac 0.14.0, the Vala compiler
...
void resources_sparql_query (Resources* self, const gchar* query, GAsyncReadyCallback _callback_, gpointer _user_data_) {
#line 30 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
gdouble status_get_progress (Status* self, GError** error) {
#line 38 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
gchar* status_get_status (Status* self, GError** error) {
#line 39 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 36 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
static void _test_app_on_status_cb_status_progress (Status* _sender, const gchar* status, gdouble progress, gpointer self) {
#line 67 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 51 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 860 "test-busy-handling.c"
	{
		...
		gdouble _tmp13_;
		gboolean _tmp15_;
#line 57 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 62 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 68 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 68 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		progress = _tmp8_;
#line 69 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 69 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		status = _tmp11_;
#line 71 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp13_ = progress;
#line 71 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		if (_tmp13_ == 1.0) {
...
#line 53 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_g_free0 (status);
...
#line 53 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_inner_error_ = NULL;
#line 74 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp16_ = e;
#line 74 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp17_ = _tmp16_->message;
#line 74 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_warning ("test-busy-handling.vala:74: Could not connect to D-Bus service: %s", _tmp17_);
#line 75 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		self->priv->initialized = FALSE;
#line 76 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		self->priv->res = -1;
#line 77 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_g_error_free0 (e);
#line 77 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		return self;
...
#line 79 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
static void test_app_on_status_cb (TestApp* self, const gchar* status, gdouble progress) {
	...
	gdouble _tmp1_;
	gdouble _tmp2_;
#line 82 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_return_if_fail (self != NULL);
#line 82 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_return_if_fail (status != NULL);
#line 83 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp0_ = status;
#line 83 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp1_ = progress;
#line 83 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_print ("%s: %f\n", _tmp0_, _tmp1_);
#line 85 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp2_ = progress;
#line 85 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (_tmp2_ == 1.0) {
#line 86 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
static void test_app_do_query_tests_async_data_free (gpointer _data) {
	...
	_data_ = _data;
#line 42 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1096 "test-busy-handling.c"
}


static void test_app_do_query_tests_async_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	TestAppDoQueryTestsAsyncData* _data_;
#line 93 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_ = _user_data_;
#line 93 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 93 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_do_query_tests_async_co (_data_);
#line 1110 "test-busy-handling.c"
}


static gboolean test_app_do_query_tests_async_co (TestAppDoQueryTestsAsyncData* _data_) {
#line 90 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	switch (_data_->_state_) {
#line 90 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 0:
#line 1119 "test-busy-handling.c"
		goto _state_0;
#line 90 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 1:
#line 1123 "test-busy-handling.c"
		goto _state_1;
		default:
#line 90 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1128 "test-busy-handling.c"
	...
	_state_0:
	{
#line 92 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_data_->cnt = 0;
#line 93 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1160 "test-busy-handling.c"
		...
		{
#line 94 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1180 "test-busy-handling.c"
				{
#line 95 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 97 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_data_->_tmp6_ = _data_->test_name;
#line 97 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_data_->_tmp7_ = _data_->cnt;
#line 97 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_print ("%s: Saw %d strings in result\n", _data_->_tmp6_, _data_->_tmp7_);
#line 91 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 99 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_data_->_tmp8_ = _data_->e;
#line 99 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_data_->_tmp9_ = _data_->_tmp8_->message;
#line 99 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_print ("Fail: %s\n", _data_->_tmp9_);
#line 100 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
static void test_app_check_shutdown (TestApp* self) {
	gint _tmp0_;
	gint _tmp1_;
#line 104 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_return_if_fail (self != NULL);
#line 105 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp0_ = self->priv->users;
#line 105 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self->priv->users = _tmp0_ - 1;
#line 106 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp1_ = self->priv->users;
#line 106 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (_tmp1_ == 0) {
#line 1263 "test-busy-handling.c"
		GMainLoop* _tmp2_;
#line 107 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_print ("Async tests done, now I can quit the mainloop\n");
#line 108 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
static void test_app_do_async_query_tests_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	TestAppDoAsyncQueryTestsData* _data_;
#line 115 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_ = _user_data_;
#line 115 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_->_source_object_ = source_object;
#line 115 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
static gboolean test_app_do_async_query_tests_co (TestAppDoAsyncQueryTestsData* _data_) {
#line 112 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	switch (_data_->_state_) {
#line 112 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 0:
...
#line 1342 "test-busy-handling.c"
	...
	_state_0:
#line 113 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_print ("Test 1: Just launch the query and let it wait\n" \
"Test 1: query launches immediately\n");
#line 114 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 117 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
static void test_app_jumper_async_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	TestAppJumperAsyncData* _data_;
#line 121 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_ = _user_data_;
#line 121 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_->_source_object_ = source_object;
#line 121 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
static gboolean test_app_jumper_async_co (TestAppJumperAsyncData* _data_) {
#line 120 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	switch (_data_->_state_) {
#line 120 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 0:
...
#line 121 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_do_query_tests_finish (_data_->self, _data_->_res_);
#line 122 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_check_shutdown (_data_->self);
#line 120 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (_data_->_state_ == 0) {
#line 120 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
static gboolean test_app_test_ready (TestApp* self) {
	...
	gboolean _tmp0_;
	gboolean _tmp1_;
#line 125 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 127 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp0_ = self->priv->ready;
#line 127 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (_tmp0_) {
#line 128 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_print ("Test 2: query launches now\n");
#line 129 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		test_app_jumper_async (self, NULL, NULL);
#line 1494 "test-busy-handling.c"
	}
#line 132 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 142 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
...
static gboolean test_app_in_mainloop (TestApp* self) {
	...
	gint _tmp0_;
	gboolean _tmp1_;
#line 135 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 136 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_do_async_query_tests (self, NULL, NULL);
#line 138 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_print ("Test 2: Wait for the status signal to indicate readyness\n");
#line 139 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp0_ = self->priv->users;
#line 139 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self->priv->users = _tmp0_ + 1;
#line 141 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp1_ = self->priv->ready;
#line 141 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (!_tmp1_) {
#line 142 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 144 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		test_app_test_ready (self);
#line 1539 "test-busy-handling.c"
	}
#line 147 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	result = FALSE;
#line 147 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
...
#line 153 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
...
gint test_app_run (TestApp* self) {
	...
	GMainLoop* _tmp1_;
	gint _tmp2_;
#line 150 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_return_val_if_fail (self != NULL, 0);
#line 151 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 155 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp1_ = self->priv->loop;
#line 155 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_main_loop_run (_tmp1_);
#line 157 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 45 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self->priv->res = -1;
#line 46 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self->priv->users = 0;
#line 48 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self->priv->initialized = FALSE;
#line 49 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 42 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self = TEST_APP (obj);
#line 47 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_g_main_loop_unref0 (self->priv->loop);
...
gint _vala_main (gchar** args, int args_length1) {
	...
	TestApp* app;
	gint _tmp1_ = 0;
#line 162 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_tmp0_ = test_app_new ();
#line 162 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	app = _tmp0_;
#line 164 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 161 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_type_init ();
#line 161 "/home/juerg/Code/tracker/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
