/* test-busy-handling.c generated by valac 0.35.1.15-f996c-dirty, the Vala compiler
...
#line 77 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		return self;
#line 1029 "test-busy-handling.c"
	}
	__finally0:
#line 53 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (G_UNLIKELY (_inner_error_ != NULL)) {
...
#line 1053 "test-busy-handling.c"
}
...
#line 1077 "test-busy-handling.c"
	}
}
...
#line 1127 "test-busy-handling.c"
}
...
#line 1167 "test-busy-handling.c"
	}
	_state_0:
	{
...
#line 93 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		return FALSE;
#line 1181 "test-busy-handling.c"
		_state_1:
#line 93 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1193 "test-busy-handling.c"
...
#line 1211 "test-busy-handling.c"
				{
...
#line 1231 "test-busy-handling.c"
	}
	goto __finally1;
	__catch1_g_error:
	{
...
#line 1250 "test-busy-handling.c"
	}
	__finally1:
#line 91 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
...
#line 106 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (_tmp1_ == 0) {
#line 1295 "test-busy-handling.c"
		GMainLoop* _tmp2_;
...
#line 1334 "test-busy-handling.c"
}
...
#line 112 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
			g_main_context_iteration (g_task_get_context (_data_->_async_result), TRUE);
#line 1403 "test-busy-handling.c"
		}
	}
#line 112 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_object_unref (_data_->_async_result);
#line 112 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return FALSE;
#line 1410 "test-busy-handling.c"
}
...
#line 120 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 0:
#line 1471 "test-busy-handling.c"
		goto _state_0;
#line 120 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 1:
#line 1475 "test-busy-handling.c"
		goto _state_1;
		default:
#line 120 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_assert_not_reached ();
...
#line 121 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return FALSE;
#line 1489 "test-busy-handling.c"
	_state_1:
#line 121 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_do_query_tests_finish (_data_->self, _data_->_res_);
...
#line 120 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
			g_main_context_iteration (g_task_get_context (_data_->_async_result), TRUE);
#line 1503 "test-busy-handling.c"
		}
	}
#line 120 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_object_unref (_data_->_async_result);
...
#line 1528 "test-busy-handling.c"
	}
...
#line 1569 "test-busy-handling.c"
	} else {
...
#line 1624 "test-busy-handling.c"
}
...
#line 1673 "test-busy-handling.c"
		}
#line 42 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 42 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		*object_p = NULL;
#line 1702 "test-busy-handling.c"
...
#line 42 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return value->data[0].v_pointer;
#line 1737 "test-busy-handling.c"
}
...
#line 42 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		value->data[0].v_pointer = NULL;
#line 1761 "test-busy-handling.c"
	}
#line 42 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (old) {
#line 42 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 42 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		value->data[0].v_pointer = NULL;
#line 1790 "test-busy-handling.c"
	}
#line 42 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (old) {
#line 42 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 42 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self->ref_count = 1;
#line 1825 "test-busy-handling.c"
}
...
#line 42 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return instance;
#line 1862 "test-busy-handling.c"
}
...
#line 1875 "test-busy-handling.c"
	}
}
...
#line 164 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1897 "test-busy-handling.c"
}
