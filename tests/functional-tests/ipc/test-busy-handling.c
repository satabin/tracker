/* test-busy-handling.c generated by valac 0.24.0.131-42e78, the Vala compiler
...
#line 77 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		return self;
#line 1020 "test-busy-handling.c"
	}
	__finally0:
#line 53 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (G_UNLIKELY (_inner_error_ != NULL)) {
...
#line 53 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		return NULL;
#line 1031 "test-busy-handling.c"
	}
...
#line 1044 "test-busy-handling.c"
}
...
#line 1068 "test-busy-handling.c"
	}
}
...
#line 1082 "test-busy-handling.c"
}
...
#line 1089 "test-busy-handling.c"
}
...
#line 1118 "test-busy-handling.c"
}
...
#line 1126 "test-busy-handling.c"
}
...
#line 93 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_do_query_tests_async_co (_data_);
#line 1140 "test-busy-handling.c"
}
...
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 0:
#line 1149 "test-busy-handling.c"
		goto _state_0;
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 1:
#line 1153 "test-busy-handling.c"
		goto _state_1;
		default:
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_assert_not_reached ();
#line 1158 "test-busy-handling.c"
	}
	_state_0:
	{
...
#line 93 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		return FALSE;
#line 1178 "test-busy-handling.c"
		_state_1:
#line 93 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_data_->_tmp3_ = NULL;
#line 93 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1196 "test-busy-handling.c"
...
#line 1216 "test-busy-handling.c"
				{
...
#line 94 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
					_g_free0 (_data_->res);
#line 1226 "test-busy-handling.c"
				}
			}
		}
...
#line 1242 "test-busy-handling.c"
	}
	goto __finally1;
	__catch1_g_error:
	{
...
#line 1265 "test-busy-handling.c"
	}
	__finally1:
#line 91 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
...
#line 91 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		return FALSE;
#line 1276 "test-busy-handling.c"
	}
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (_data_->_state_ == 0) {
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 106 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (_tmp1_ == 0) {
#line 1309 "test-busy-handling.c"
...
#line 1317 "test-busy-handling.c"
	}
}
...
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_ = g_simple_async_result_get_op_res_gpointer (G_SIMPLE_ASYNC_RESULT (_res_));
#line 1356 "test-busy-handling.c"
}
...
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_do_async_query_tests_co (_data_);
#line 1370 "test-busy-handling.c"
}
...
#line 112 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 1:
#line 1383 "test-busy-handling.c"
		goto _state_1;
		default:
#line 112 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_assert_not_reached ();
...
#line 1436 "test-busy-handling.c"
}
...
#line 1455 "test-busy-handling.c"
}
...
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_ = g_simple_async_result_get_op_res_gpointer (G_SIMPLE_ASYNC_RESULT (_res_));
#line 1463 "test-busy-handling.c"
}
...
#line 121 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_jumper_async_co (_data_);
#line 1477 "test-busy-handling.c"
}
...
#line 120 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 0:
#line 1486 "test-busy-handling.c"
		goto _state_0;
#line 120 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 1:
...
#line 120 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_assert_not_reached ();
#line 1495 "test-busy-handling.c"
	}
	_state_0:
#line 121 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_->_state_ = 1;
...
#line 121 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return FALSE;
#line 1504 "test-busy-handling.c"
	_state_1:
#line 121 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_do_query_tests_finish (_data_->self, _data_->_res_);
...
#line 120 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_simple_async_result_complete_in_idle (_data_->_async_result);
#line 1514 "test-busy-handling.c"
	} else {
#line 120 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_simple_async_result_complete (_data_->_async_result);
...
#line 1542 "test-busy-handling.c"
	}
...
#line 132 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1550 "test-busy-handling.c"
}
...
#line 142 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1559 "test-busy-handling.c"
}
...
#line 153 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1602 "test-busy-handling.c"
}
...
#line 1638 "test-busy-handling.c"
}
...
#line 1661 "test-busy-handling.c"
	}
}
...
#line 1669 "test-busy-handling.c"
}
...
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return NULL;
#line 1699 "test-busy-handling.c"
}
...
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return NULL;
#line 1728 "test-busy-handling.c"
}
...
#line 1742 "test-busy-handling.c"
}
...
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return value->data[0].v_pointer;
#line 1751 "test-busy-handling.c"
}
...
#line 1822 "test-busy-handling.c"
}
...
#line 47 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_g_main_loop_unref0 (self->priv->loop);
#line 1851 "test-busy-handling.c"
}
...
#line 42 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return instance;
#line 1876 "test-busy-handling.c"
}
...
#line 1889 "test-busy-handling.c"
	}
}
...
#line 164 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1911 "test-busy-handling.c"
}
