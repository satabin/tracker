/* test-busy-handling.c generated by valac 0.22.1, the Vala compiler
...
#line 68 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp8_ = status_get_progress (_tmp7_, &_inner_error_);
#line 68 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp6_ = _tmp8_;
#line 68 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		if (_inner_error_ != NULL) {
...
#line 69 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp11_ = status_get_status (_tmp10_, &_inner_error_);
#line 69 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_tmp9_ = _tmp11_;
#line 69 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		if (_inner_error_ != NULL) {
...
#line 93 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		return FALSE;
#line 1150 "test-busy-handling.c"
		_state_1:
#line 93 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		_data_->_tmp3_ = NULL;
#line 93 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1214 "test-busy-handling.c"
	}
	goto __finally1;
	__catch1_g_error:
	{
...
#line 1254 "test-busy-handling.c"
	} else {
#line 90 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 90 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return FALSE;
#line 1264 "test-busy-handling.c"
}
...
#line 1289 "test-busy-handling.c"
	}
}
...
#line 1301 "test-busy-handling.c"
}
...
#line 1320 "test-busy-handling.c"
}
...
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_ = g_simple_async_result_get_op_res_gpointer (G_SIMPLE_ASYNC_RESULT (_res_));
#line 1328 "test-busy-handling.c"
}
...
#line 112 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 0:
#line 1351 "test-busy-handling.c"
		goto _state_0;
#line 112 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 1:
...
#line 112 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_assert_not_reached ();
#line 1360 "test-busy-handling.c"
	}
	_state_0:
...
#line 112 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_simple_async_result_complete_in_idle (_data_->_async_result);
#line 1387 "test-busy-handling.c"
	} else {
#line 112 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_simple_async_result_complete (_data_->_async_result);
#line 1391 "test-busy-handling.c"
	}
#line 112 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	g_object_unref (_data_->_async_result);
#line 112 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1408 "test-busy-handling.c"
}
...
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_ = g_simple_async_result_get_op_res_gpointer (G_SIMPLE_ASYNC_RESULT (_res_));
#line 1435 "test-busy-handling.c"
}
...
#line 121 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	test_app_jumper_async_co (_data_);
#line 1449 "test-busy-handling.c"
}
...
#line 120 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		case 1:
#line 1462 "test-busy-handling.c"
		goto _state_1;
		default:
#line 120 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		g_assert_not_reached ();
#line 1467 "test-busy-handling.c"
	}
	_state_0:
#line 121 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_data_->_state_ = 1;
...
#line 132 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1522 "test-busy-handling.c"
}
...
#line 153 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1574 "test-busy-handling.c"
}
...
#line 157 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1603 "test-busy-handling.c"
}
...
#line 1610 "test-busy-handling.c"
}
...
#line 1619 "test-busy-handling.c"
	}
}
...
#line 1629 "test-busy-handling.c"
	} else {
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
...
#line 1648 "test-busy-handling.c"
		TestApp* object;
...
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		*object_p = NULL;
#line 1688 "test-busy-handling.c"
	} else if (collect_flags & G_VALUE_NOCOPY_CONTENTS) {
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		*object_p = value->data[0].v_pointer;
#line 1692 "test-busy-handling.c"
	} else {
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		*object_p = test_app_ref (value->data[0].v_pointer);
#line 1696 "test-busy-handling.c"
	}
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return NULL;
#line 1700 "test-busy-handling.c"
}
...
#line 1743 "test-busy-handling.c"
	} else {
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		value->data[0].v_pointer = NULL;
...
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		value->data[0].v_pointer = v_object;
#line 1772 "test-busy-handling.c"
	} else {
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		value->data[0].v_pointer = NULL;
#line 1776 "test-busy-handling.c"
	}
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	if (old) {
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
		test_app_unref (old);
#line 1782 "test-busy-handling.c"
	}
}
...
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	self->ref_count = 1;
#line 1811 "test-busy-handling.c"
}
...
#line 47 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	_g_main_loop_unref0 (self->priv->loop);
#line 1821 "test-busy-handling.c"
}
...
#line 42 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return instance;
#line 1846 "test-busy-handling.c"
}
...
#line 1859 "test-busy-handling.c"
	}
}
...
#line 164 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-busy-handling.vala"
	return result;
#line 1881 "test-busy-handling.c"
}
...
#line 1888 "test-busy-handling.c"
}
