/* test-class-signal-performance-batch.c generated by valac 0.24.0.131-42e78, the Vala compiler
...
#line 707 "test-class-signal-performance-batch.c"
...
#line 726 "test-class-signal-performance-batch.c"
			goto __catch0_g_error;
		}
#line 56 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
		_tmp6_ = _tmp4_;
...
#line 53 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
		_g_object_unref0 (_tmp1_);
#line 751 "test-class-signal-performance-batch.c"
	}
	goto __finally0;
	__catch0_g_error:
	{
...
#line 68 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
		return self;
#line 775 "test-class-signal-performance-batch.c"
	}
	__finally0:
#line 53 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
	if (G_UNLIKELY (_inner_error_ != NULL)) {
...
#line 53 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
		return NULL;
#line 786 "test-class-signal-performance-batch.c"
	}
...
#line 799 "test-class-signal-performance-batch.c"
}
...
#line 829 "test-class-signal-performance-batch.c"
			Event insert = {0};
#line 74 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
			insert = insert_collection[insert_it];
#line 833 "test-class-signal-performance-batch.c"
			{
				gint _tmp1_ = 0;
...
#line 840 "test-class-signal-performance-batch.c"
			}
		}
	}
...
#line 852 "test-class-signal-performance-batch.c"
}
...
#line 79 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
	g_return_if_fail (self != NULL);
#line 861 "test-class-signal-performance-batch.c"
	{
		gboolean _tmp0_ = FALSE;
...
#line 81 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
		while (TRUE) {
#line 870 "test-class-signal-performance-batch.c"
			gint _tmp2_ = 0;
			gchar* upqry = NULL;
			gint _tmp3_ = 0;
			gchar* _tmp4_ = NULL;
...
#line 81 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
			if (!_tmp0_) {
#line 879 "test-class-signal-performance-batch.c"
				gint _tmp1_ = 0;
#line 81 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
				_tmp1_ = i;
#line 81 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
...
#line 81 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
				break;
#line 895 "test-class-signal-performance-batch.c"
			}
...
#line 81 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
			_g_free0 (upqry);
#line 911 "test-class-signal-performance-batch.c"
		}
	}
...
#line 87 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
		while (TRUE) {
#line 927 "test-class-signal-performance-batch.c"
			gint _tmp10_ = 0;
			gchar* upqry = NULL;
			gint _tmp11_ = 0;
			gint _tmp12_ = 0;
...
#line 87 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
			if (!_tmp8_) {
#line 936 "test-class-signal-performance-batch.c"
				gint _tmp9_ = 0;
#line 87 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
				_tmp9_ = i;
#line 87 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
...
#line 87 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
				break;
#line 952 "test-class-signal-performance-batch.c"
			}
...
#line 966 "test-class-signal-performance-batch.c"
...
#line 985 "test-class-signal-performance-batch.c"
			}
#line 87 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
			_g_free0 (upqry);
...
#line 100 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
	return result;
#line 1005 "test-class-signal-performance-batch.c"
}
...
#line 107 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
	return result;
#line 1040 "test-class-signal-performance-batch.c"
}
...
#line 1047 "test-class-signal-performance-batch.c"
}
...
#line 1070 "test-class-signal-performance-batch.c"
	}
}
...
#line 1078 "test-class-signal-performance-batch.c"
}
...
#line 1092 "test-class-signal-performance-batch.c"
		} else if (!g_value_type_compatible (G_TYPE_FROM_INSTANCE (object), G_VALUE_TYPE (value))) {
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
			return g_strconcat ("invalid object type `", g_type_name (G_TYPE_FROM_INSTANCE (object)), "' for value type `", G_VALUE_TYPE_NAME (value), "'", NULL);
#line 1096 "test-class-signal-performance-batch.c"
		}
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
...
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
		value->data[0].v_pointer = NULL;
#line 1104 "test-class-signal-performance-batch.c"
	}
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
	return NULL;
#line 1108 "test-class-signal-performance-batch.c"
}
...
#line 1133 "test-class-signal-performance-batch.c"
	}
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
	return NULL;
#line 1137 "test-class-signal-performance-batch.c"
}
...
#line 1151 "test-class-signal-performance-batch.c"
}
...
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
	return value->data[0].v_pointer;
#line 1160 "test-class-signal-performance-batch.c"
}
...
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
		value->data[0].v_pointer = NULL;
#line 1184 "test-class-signal-performance-batch.c"
	}
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
	if (old) {
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
...
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
		value->data[0].v_pointer = NULL;
#line 1213 "test-class-signal-performance-batch.c"
	}
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
	if (old) {
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
		test_app_unref (old);
#line 1219 "test-class-signal-performance-batch.c"
	}
}
...
#line 1231 "test-class-signal-performance-batch.c"
}
...
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
	self->ref_count = 1;
#line 1244 "test-class-signal-performance-batch.c"
}
...
#line 49 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
	_g_timer_destroy0 (self->priv->t);
#line 1260 "test-class-signal-performance-batch.c"
}
...
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
	return instance;
#line 1285 "test-class-signal-performance-batch.c"
}
...
#line 1298 "test-class-signal-performance-batch.c"
	}
}
...
#line 114 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance-batch.vala"
	return result;
#line 1320 "test-class-signal-performance-batch.c"
}
...
#line 1330 "test-class-signal-performance-batch.c"
}
