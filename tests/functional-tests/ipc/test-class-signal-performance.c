/* test-class-signal-performance.c generated by valac 0.19.0.3-f335, the Vala compiler
...
Event* event_dup (const Event* self) {
	Event* dup;
#line 47 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	dup = g_new0 (Event, 1);
#line 47 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	memcpy (dup, self, sizeof (Event));
#line 47 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	return dup;
#line 227 "test-class-signal-performance.c"
}
...
#line 47 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_free (self);
#line 234 "test-class-signal-performance.c"
}
...
void resources_sparql_update_async (Resources* self, const gchar* query, GAsyncReadyCallback _callback_, gpointer _user_data_) {
#line 55 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	RESOURCES_GET_INTERFACE (self)->sparql_update_async (self, query, _callback_, _user_data_);
#line 252 "test-class-signal-performance.c"
}
...
#line 259 "test-class-signal-performance.c"
}
...
#line 278 "test-class-signal-performance.c"
	} else {
#line 55 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		data1 = param_values->data[0].v_pointer;
#line 55 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		data2 = closure->data;
#line 284 "test-class-signal-performance.c"
	}
#line 55 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 290 "test-class-signal-performance.c"
}
...
#line 303 "test-class-signal-performance.c"
	}
}
...
static void g_cclosure_user_marshal_VOID__BOXED_INT (GClosure * closure, GValue * return_value, guint n_param_values, const GValue * param_values, gpointer invocation_hint, gpointer marshal_data) {
	...
	register gpointer data2;
	cc = (GCClosure *) closure;
#line 64 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 64 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		data2 = param_values->data[0].v_pointer;
#line 645 "test-class-signal-performance.c"
	} else {
#line 64 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		data1 = param_values->data[0].v_pointer;
#line 64 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		data2 = closure->data;
#line 651 "test-class-signal-performance.c"
	}
#line 64 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 657 "test-class-signal-performance.c"
}
...
#line 64 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		data2 = param_values->data[0].v_pointer;
#line 676 "test-class-signal-performance.c"
	} else {
#line 64 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		data1 = param_values->data[0].v_pointer;
#line 64 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		data2 = closure->data;
#line 682 "test-class-signal-performance.c"
	}
#line 64 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 688 "test-class-signal-performance.c"
}
...
#line 64 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		initialized = TRUE;
#line 64 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		g_signal_new ("subjects_added", TYPE_RESOURCESCLASS, G_SIGNAL_RUN_LAST, 0, NULL, NULL, g_cclosure_user_marshal_VOID__BOXED_INT, G_TYPE_NONE, 2, G_TYPE_STRV, G_TYPE_INT);
#line 64 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		g_signal_new ("subjects_changed", TYPE_RESOURCESCLASS, G_SIGNAL_RUN_LAST, 0, NULL, NULL, g_cclosure_user_marshal_VOID__BOXED_INT_BOXED_INT, G_TYPE_NONE, 4, G_TYPE_STRV, G_TYPE_INT, G_TYPE_STRV, G_TYPE_INT);
#line 703 "test-class-signal-performance.c"
	}
}
...
GType resourcesclass_get_type (void) {
	...
	if (g_once_init_enter (&resourcesclass_type_id__volatile)) {
		...
		g_type_interface_add_prerequisite (resourcesclass_type_id, G_TYPE_DBUS_PROXY);
...
static void _test_app_on_subjects_added_resourcesclass_subjects_added (ResourcesClass* _sender, gchar** subjects, int subjects_length1, gpointer self) {
#line 95 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	test_app_on_subjects_added (self, subjects, subjects_length1);
#line 963 "test-class-signal-performance.c"
}


static void _test_app_on_subjects_changed_resourcesclass_subjects_changed (ResourcesClass* _sender, gchar** subjects, int subjects_length1, gchar** preds, int preds_length1, gpointer self) {
#line 96 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	test_app_on_subjects_changed (self, subjects, subjects_length1, preds, preds_length1);
#line 970 "test-class-signal-performance.c"
}


static void _test_app_on_graph_updated_received_resources_graph_updated (Resources* _sender, const gchar* class_name, Event* deletes, int deletes_length1, Event* inserts, int inserts_length1, gpointer self) {
#line 98 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	test_app_on_graph_updated_received (self, class_name, deletes, deletes_length1, inserts, inserts_length1);
#line 977 "test-class-signal-performance.c"
}
...
#line 80 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 991 "test-class-signal-performance.c"
	{
		...
		Resources* _tmp4_;
		ResourcesClass* _tmp5_ = NULL;
		ResourcesClass* _tmp6_;
		ResourcesClass* _tmp7_;
		ResourcesClass* _tmp8_;
		Resources* _tmp9_;
		GTimer* _tmp10_;
#line 83 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_tmp1_ = tracker_sparql_connection_get (NULL, &_inner_error_);
#line 83 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_tmp2_ = _tmp1_;
#line 83 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		if (_inner_error_ != NULL) {
#line 1009 "test-class-signal-performance.c"
...
#line 85 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 85 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		if (_inner_error_ != NULL) {
#line 1022 "test-class-signal-performance.c"
			goto __catch0_g_error;
		}
#line 85 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_tmp5_ = g_initable_new (TYPE_RESOURCESCLASS_PROXY, NULL, &_inner_error_, "g-flags", G_DBUS_PROXY_FLAGS_DO_NOT_LOAD_PROPERTIES | G_DBUS_PROXY_FLAGS_DO_NOT_CONNECT_SIGNALS, "g-name", "org.freedesktop.Tracker1", "g-bus-type", G_BUS_TYPE_SESSION, "g-object-path", "/org/freedesktop/Tracker1/Resources/Classes/nmm/MusicPiece", "g-interface-name", "org.freedesktop.Tracker1.Resources.Class", NULL);
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_tmp6_ = (ResourcesClass*) _tmp5_;
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		if (_inner_error_ != NULL) {
#line 1035 "test-class-signal-performance.c"
			goto __catch0_g_error;
		}
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_g_object_unref0 (test_app_class_object);
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		test_app_class_object = _tmp6_;
#line 95 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_tmp7_ = test_app_class_object;
#line 95 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		g_signal_connect (_tmp7_, "subjects-added", (GCallback) _test_app_on_subjects_added_resourcesclass_subjects_added, self);
#line 96 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_tmp8_ = test_app_class_object;
#line 96 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		g_signal_connect (_tmp8_, "subjects-changed", (GCallback) _test_app_on_subjects_changed_resourcesclass_subjects_changed, self);
#line 98 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 99 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_tmp10_ = g_timer_new ();
#line 99 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_g_timer_destroy0 (self->priv->t);
#line 99 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		self->priv->t = _tmp10_;
#line 1060 "test-class-signal-performance.c"
	}
	goto __finally0;
	__catch0_g_error:
	{
		...
		GError* _tmp11_;
		const gchar* _tmp12_;
#line 82 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		e = _inner_error_;
#line 82 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_inner_error_ = NULL;
#line 102 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_tmp11_ = e;
#line 102 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
"vice: %s", _tmp12_);
#line 103 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		self->priv->initialized = FALSE;
#line 104 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_g_error_free0 (e);
#line 104 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		return self;
#line 1084 "test-class-signal-performance.c"
	}
	__finally0:
#line 82 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	if (_inner_error_ != NULL) {
...
#line 82 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		return NULL;
#line 1095 "test-class-signal-performance.c"
	}
#line 106 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	self->priv->initialized = TRUE;
#line 80 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	return self;
#line 1101 "test-class-signal-performance.c"
}
...
static void test_app_on_subjects_changed (TestApp* self, gchar** subjects, int subjects_length1, gchar** preds, int preds_length1) {
	...
	GTimer* _tmp4_;
	gdouble _tmp5_ = 0.0;
#line 109 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_return_if_fail (self != NULL);
#line 110 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp0_ = subjects;
#line 110 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp0__length1 = subjects_length1;
#line 1124 "test-class-signal-performance.c"
	{
...
#line 1136 "test-class-signal-performance.c"
			gchar* _tmp1_;
			gchar* s = NULL;
#line 110 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 1143 "test-class-signal-performance.c"
			{
				gint _tmp2_;
#line 111 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
				_tmp2_ = self->priv->count;
#line 111 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
				self->priv->count = _tmp2_ + 1;
#line 110 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
				_g_free0 (s);
#line 1152 "test-class-signal-performance.c"
			}
		}
	}
#line 114 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 1164 "test-class-signal-performance.c"
}
...
static void test_app_on_subjects_added (TestApp* self, gchar** subjects, int subjects_length1) {
	...
	GTimer* _tmp4_;
	gdouble _tmp5_ = 0.0;
#line 117 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_return_if_fail (self != NULL);
#line 118 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp0_ = subjects;
#line 118 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp0__length1 = subjects_length1;
#line 1180 "test-class-signal-performance.c"
	{
		gchar** s_collection = NULL;
		gint s_collection_length1 = 0;
		gint _s_collection_size_ = 0;
...
#line 118 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		for (s_it = 0; s_it < _tmp0__length1; s_it = s_it + 1) {
#line 1192 "test-class-signal-performance.c"
			gchar* _tmp1_;
			gchar* s = NULL;
#line 118 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
			_tmp1_ = g_strdup (s_collection[s_it]);
#line 118 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
			s = _tmp1_;
#line 1199 "test-class-signal-performance.c"
			{
				gint _tmp2_;
#line 119 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
				_tmp2_ = self->priv->count;
#line 119 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
				self->priv->count = _tmp2_ + 1;
#line 118 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
				_g_free0 (s);
#line 1208 "test-class-signal-performance.c"
			}
		}
	}
#line 122 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp3_ = self->priv->count;
#line 122 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp4_ = self->priv->t;
#line 122 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 122 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_print ("Old class signal count=%d time=%lf\n", _tmp3_, _tmp5_);
#line 1220 "test-class-signal-performance.c"
}
...
static void test_app_on_graph_updated_received (TestApp* self, const gchar* class_name, Event* deletes, int deletes_length1, Event* inserts, int inserts_length1) {
	...
	GTimer* _tmp3_;
	gdouble _tmp4_ = 0.0;
#line 125 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_return_if_fail (self != NULL);
#line 125 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_return_if_fail (class_name != NULL);
#line 126 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp0_ = inserts;
#line 126 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 1250 "test-class-signal-performance.c"
			Event insert = {0};
#line 126 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 1254 "test-class-signal-performance.c"
			{
				gint _tmp1_;
#line 127 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
				_tmp1_ = self->priv->count;
#line 127 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
				self->priv->count = _tmp1_ + 1;
#line 1261 "test-class-signal-performance.c"
			}
		}
	}
#line 129 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp2_ = self->priv->count;
#line 129 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp3_ = self->priv->t;
#line 129 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 1273 "test-class-signal-performance.c"
}
...
static void test_app_insert_data (TestApp* self) {
	gint i = 0;
	GTimer* _tmp0_;
#line 132 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_return_if_fail (self != NULL);
#line 135 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp0_ = self->priv->t;
#line 135 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 1286 "test-class-signal-performance.c"
	{
		gboolean _tmp1_;
#line 136 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		i = 0;
#line 136 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_tmp1_ = TRUE;
#line 136 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		while (TRUE) {
#line 1295 "test-class-signal-performance.c"
			gboolean _tmp2_;
			gint _tmp4_;
			gint _tmp5_;
			gint _tmp6_;
...
#line 136 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
			if (!_tmp2_) {
#line 1308 "test-class-signal-performance.c"
				gint _tmp3_;
#line 136 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
				_tmp3_ = i;
#line 136 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
				i = _tmp3_ + 1;
#line 1314 "test-class-signal-performance.c"
			}
#line 136 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
			_tmp1_ = FALSE;
#line 136 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
			_tmp4_ = i;
#line 136 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
			if (!(_tmp4_ <= max_signals)) {
#line 136 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
				break;
#line 1324 "test-class-signal-performance.c"
			}
#line 137 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
			_tmp5_ = i;
#line 137 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
			_tmp6_ = i;
#line 137 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
			_tmp7_ = g_strdup_printf ("INSERT { <%d> a nmm:MusicPiece ; nie:title '%s %d' }", _tmp5_, title_data, _tmp6_);
#line 137 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
			upqry = _tmp7_;
#line 138 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 136 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
			_g_free0 (upqry);
#line 1342 "test-class-signal-performance.c"
		}
	}
}
...
#line 142 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 143 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	test_app_insert_data (self);
#line 144 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	result = FALSE;
#line 144 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	return result;
#line 1358 "test-class-signal-performance.c"
}
...
#line 149 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	return result;
...
gint test_app_run (TestApp* self) {
	...
	GMainLoop* _tmp0_;
	GMainLoop* _tmp1_;
#line 147 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_return_val_if_fail (self != NULL, 0);
#line 148 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 150 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp1_ = self->priv->loop;
#line 150 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_main_loop_run (_tmp1_);
#line 151 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	result = 0;
#line 151 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	return result;
#line 1393 "test-class-signal-performance.c"
}


static void value_test_app_init (GValue* value) {
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	value->data[0].v_pointer = NULL;
#line 1400 "test-class-signal-performance.c"
}
...
#line 1409 "test-class-signal-performance.c"
	}
}
...
#line 1419 "test-class-signal-performance.c"
	} else {
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		dest_value->data[0].v_pointer = NULL;
#line 1423 "test-class-signal-performance.c"
	}
}
...
#line 1431 "test-class-signal-performance.c"
}
...
#line 1449 "test-class-signal-performance.c"
		}
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		value->data[0].v_pointer = test_app_ref (object);
#line 1453 "test-class-signal-performance.c"
	} else {
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		value->data[0].v_pointer = NULL;
#line 1457 "test-class-signal-performance.c"
	}
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	return NULL;
#line 1461 "test-class-signal-performance.c"
}
...
#line 1472 "test-class-signal-performance.c"
	}
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	if (!value->data[0].v_pointer) {
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		*object_p = NULL;
#line 1478 "test-class-signal-performance.c"
	} else if (collect_flags & G_VALUE_NOCOPY_CONTENTS) {
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		*object_p = value->data[0].v_pointer;
#line 1482 "test-class-signal-performance.c"
	} else {
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		*object_p = test_app_ref (value->data[0].v_pointer);
#line 1486 "test-class-signal-performance.c"
	}
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	return NULL;
...
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	return value->data[0].v_pointer;
#line 1513 "test-class-signal-performance.c"
}
...
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		value->data[0].v_pointer = NULL;
#line 1537 "test-class-signal-performance.c"
	}
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	if (old) {
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		test_app_unref (old);
#line 1543 "test-class-signal-performance.c"
	}
}
...
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		value->data[0].v_pointer = v_object;
#line 1562 "test-class-signal-performance.c"
	} else {
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		value->data[0].v_pointer = NULL;
#line 1566 "test-class-signal-performance.c"
	}
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	if (old) {
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		test_app_unref (old);
#line 1572 "test-class-signal-performance.c"
	}
}
...
#line 1584 "test-class-signal-performance.c"
}
...
#line 75 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	self->priv->initialized = FALSE;
#line 77 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	self->priv->count = 0;
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	self->ref_count = 1;
#line 1597 "test-class-signal-performance.c"
}
...
#line 74 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_g_main_loop_unref0 (self->priv->loop);
#line 76 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_g_object_unref0 (self->priv->con);
#line 78 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_g_timer_destroy0 (self->priv->t);
...
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	return instance;
#line 1636 "test-class-signal-performance.c"
}
...
#line 1649 "test-class-signal-performance.c"
	}
}
...
gint _vala_main (gchar** args, int args_length1) {
	...
	TestApp* app;
	gint _tmp1_ = 0;
#line 156 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp0_ = test_app_new ();
#line 156 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	app = _tmp0_;
#line 158 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 158 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	return result;
#line 1671 "test-class-signal-performance.c"
}


int main (int argc, char ** argv) {
#line 155 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_type_init ();
#line 155 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	return _vala_main (argv, argc);
#line 1680 "test-class-signal-performance.c"
}
