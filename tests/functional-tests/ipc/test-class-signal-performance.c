/* test-class-signal-performance.c generated by valac 0.12.0.69-6c49, the Vala compiler
...
TestApp* test_app_construct (GType object_type) {
	...
	Resources* _tmp3_;
	ResourcesClass* _tmp4_ = NULL;
	ResourcesClass* _tmp5_;
	GTimer* _tmp6_ = NULL;
