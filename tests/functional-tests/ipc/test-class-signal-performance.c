/* test-class-signal-performance.c generated by valac 0.22.1, the Vala compiler
...
Event* event_dup (const Event* self) {
	Event* dup;
#line 47 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	dup = g_new0 (Event, 1);
#line 47 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
void resources_sparql_update_async (Resources* self, const gchar* query, GAsyncReadyCallback _callback_, gpointer _user_data_) {
#line 55 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
static void g_cclosure_user_marshal_VOID__BOXED_INT (GClosure * closure, GValue * return_value, guint n_param_values, const GValue * param_values, gpointer invocation_hint, gpointer marshal_data) {
	...
	register gpointer data2;
	cc = (GCClosure *) closure;
#line 64 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
static void _test_app_on_subjects_added_resourcesclass_subjects_added (ResourcesClass* _sender, gchar** subjects, int subjects_length1, gpointer self) {
#line 95 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
static void _test_app_on_subjects_changed_resourcesclass_subjects_changed (ResourcesClass* _sender, gchar** subjects, int subjects_length1, gchar** preds, int preds_length1, gpointer self) {
#line 96 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
static void _test_app_on_graph_updated_received_resources_graph_updated (Resources* _sender, const gchar* class_name, Event* deletes, int deletes_length1, Event* inserts, int inserts_length1, gpointer self) {
#line 98 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 80 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 991 "test-class-signal-performance.c"
	{
		...
		ResourcesClass* _tmp8_ = NULL;
		Resources* _tmp9_ = NULL;
		GTimer* _tmp10_ = NULL;
#line 83 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 85 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 90 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_tmp6_ = g_initable_new (TYPE_RESOURCESCLASS_PROXY, NULL, &_inner_error_, "g-flags", G_DBUS_PROXY_FLAGS_DO_NOT_LOAD_PROPERTIES | G_DBUS_PROXY_FLAGS_DO_NOT_CONNECT_SIGNALS, "g-name", "org.freedesktop.Tracker1", "g-bus-type", G_BUS_TYPE_SESSION, "g-object-path", "/org/freedesktop/Tracker1/Resources/Classes/nmm/MusicPiece", "g-interface-name", "org.freedesktop.Tracker1.Resources.Class", NULL);
#line 90 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_tmp5_ = (ResourcesClass*) _tmp6_;
#line 90 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		if (_inner_error_ != NULL) {
...
#line 99 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_tmp10_ = g_timer_new ();
#line 99 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 82 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		e = _inner_error_;
#line 82 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_inner_error_ = NULL;
#line 102 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_tmp11_ = e;
#line 102 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
"vice: %s", _tmp12_);
#line 103 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		self->priv->initialized = FALSE;
#line 104 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_g_error_free0 (e);
#line 104 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		return self;
...
#line 106 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
static void test_app_on_subjects_changed (TestApp* self, gchar** subjects, int subjects_length1, gchar** preds, int preds_length1) {
	...
	GTimer* _tmp4_ = NULL;
	gdouble _tmp5_ = 0.0;
#line 109 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_return_if_fail (self != NULL);
#line 110 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp0_ = subjects;
#line 110 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 1143 "test-class-signal-performance.c"
			{
				gint _tmp2_ = 0;
#line 111 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 114 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
static void test_app_on_subjects_added (TestApp* self, gchar** subjects, int subjects_length1) {
	...
	GTimer* _tmp4_ = NULL;
	gdouble _tmp5_ = 0.0;
#line 117 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_return_if_fail (self != NULL);
#line 118 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp0_ = subjects;
#line 118 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp0__length1 = subjects_length1;
...
#line 1199 "test-class-signal-performance.c"
			{
				gint _tmp2_ = 0;
#line 119 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
				_tmp2_ = self->priv->count;
#line 119 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
				self->priv->count = _tmp2_ + 1;
#line 118 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 122 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp3_ = self->priv->count;
#line 122 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp4_ = self->priv->t;
#line 122 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
static void test_app_on_graph_updated_received (TestApp* self, const gchar* class_name, Event* deletes, int deletes_length1, Event* inserts, int inserts_length1) {
	...
	GTimer* _tmp3_ = NULL;
	gdouble _tmp4_ = 0.0;
#line 125 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_return_if_fail (self != NULL);
#line 125 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_return_if_fail (class_name != NULL);
#line 126 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp0_ = inserts;
#line 126 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 1254 "test-class-signal-performance.c"
			{
				gint _tmp1_ = 0;
#line 127 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 129 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp2_ = self->priv->count;
#line 129 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp3_ = self->priv->t;
#line 129 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
static void test_app_insert_data (TestApp* self) {
	gint i = 0;
	GTimer* _tmp0_ = NULL;
#line 132 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_return_if_fail (self != NULL);
#line 135 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp0_ = self->priv->t;
#line 135 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 136 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		i = 0;
#line 136 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
		_tmp1_ = TRUE;
#line 136 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 137 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
			_tmp5_ = i;
#line 137 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
			_tmp6_ = i;
#line 137 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 137 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
			upqry = _tmp7_;
#line 138 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 142 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 143 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	test_app_insert_data (self);
#line 144 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	result = FALSE;
#line 144 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	return result;
...
#line 149 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	return result;
...
#line 147 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_return_val_if_fail (self != NULL, 0);
#line 148 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 150 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp1_ = self->priv->loop;
#line 150 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	g_main_loop_run (_tmp1_);
#line 151 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	result = 0;
#line 151 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	return result;
...
#line 71 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 75 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	self->priv->initialized = FALSE;
#line 77 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	self->priv->count = 0;
#line 71 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	self->ref_count = 1;
...
#line 74 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_g_main_loop_unref0 (self->priv->loop);
#line 76 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_g_object_unref0 (self->priv->con);
#line 78 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_g_timer_destroy0 (self->priv->t);
...
gint _vala_main (gchar** args, int args_length1) {
	...
	TestApp* _tmp0_ = NULL;
	gint _tmp1_ = 0;
#line 156 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	_tmp0_ = test_app_new ();
#line 156 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	app = _tmp0_;
#line 158 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
...
#line 155 "/home/martyn/Source/tracker/tests/functional-tests/ipc/test-class-signal-performance.vala"
	return _vala_main (argv, argc);
#line 1678 "test-class-signal-performance.c"
}
