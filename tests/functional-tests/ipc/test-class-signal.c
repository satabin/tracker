/* test-class-signal.c generated by valac 0.24.0.131-42e78, the Vala compiler
...
Event* event_dup (const Event* self) {
	Event* dup;
#line 27 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	dup = g_new0 (Event, 1);
#line 27 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	memcpy (dup, self, sizeof (Event));
#line 27 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	return dup;
#line 216 "test-class-signal.c"
}
...
void resources_sparql_update_async (Resources* self, const gchar* query, GAsyncReadyCallback _callback_, gpointer _user_data_) {
#line 35 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	RESOURCES_GET_INTERFACE (self)->sparql_update_async (self, query, _callback_, _user_data_);
#line 241 "test-class-signal.c"
}
...
#line 267 "test-class-signal.c"
	} else {
#line 35 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		data1 = param_values->data[0].v_pointer;
#line 35 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		data2 = closure->data;
#line 273 "test-class-signal.c"
	}
#line 35 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 58 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	return self ? g_object_ref (self) : NULL;
#line 622 "test-class-signal.c"
}


static void _test_app_on_graph_updated_received_resources_graph_updated (Resources* _sender, const gchar* class_name, Event* deletes, int deletes_length1, Event* inserts, int inserts_length1, gpointer self) {
#line 65 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	test_app_on_graph_updated_received ((TestApp*) self, class_name, deletes, deletes_length1, inserts, inserts_length1);
#line 629 "test-class-signal.c"
}
...
#line 52 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 55 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_tmp2_ = tracker_sparql_connection_get (NULL, &_inner_error_);
#line 55 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_tmp1_ = _tmp2_;
#line 55 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		if (G_UNLIKELY (_inner_error_ != NULL)) {
#line 660 "test-class-signal.c"
...
#line 60 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 54 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_g_object_unref0 (_tmp6_);
#line 54 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_g_object_unref0 (_tmp1_);
#line 706 "test-class-signal.c"
	}
	goto __finally0;
	__catch0_g_error:
	{
...
#line 54 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_inner_error_ = NULL;
#line 68 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_tmp10_ = e;
#line 68 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_tmp11_ = _tmp10_->message;
#line 68 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		g_warning ("test-class-signal.vala:68: Could not connect to D-Bus service: %s", _tmp11_);
#line 69 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		self->priv->initialized = FALSE;
#line 70 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		self->priv->res = -1;
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_g_error_free0 (e);
#line 71 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		return self;
#line 732 "test-class-signal.c"
	}
	__finally0:
#line 54 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	if (G_UNLIKELY (_inner_error_ != NULL)) {
...
#line 54 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		return NULL;
#line 743 "test-class-signal.c"
	}
#line 73 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	self->priv->initialized = TRUE;
#line 52 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	return self;
#line 749 "test-class-signal.c"
}
...
#line 81 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 81 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	g_return_val_if_fail (class_name != NULL, NULL);
#line 82 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	first = TRUE;
#line 83 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_tmp0_ = g_string_new ("SELECT ?r ?t { ?r a <");
#line 83 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	builder = _tmp0_;
#line 84 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_tmp1_ = builder;
#line 84 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_tmp2_ = class_name;
#line 84 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	g_string_append (_tmp1_, _tmp2_);
#line 85 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_tmp3_ = builder;
#line 85 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	g_string_append (_tmp3_, ">; nie:title ?t . FILTER (tracker:id (?r) IN (");
#line 86 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_tmp4_ = ids;
#line 86 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_tmp4__length1 = ids_length1;
#line 795 "test-class-signal.c"
	{
...
#line 811 "test-class-signal.c"
			{
				gboolean _tmp5_ = FALSE;
#line 87 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
				_tmp5_ = first;
#line 87 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
				if (_tmp5_) {
#line 818 "test-class-signal.c"
					GString* _tmp6_ = NULL;
					Event _tmp7_ = {0};
					gint _tmp8_ = 0;
#line 88 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
					_tmp6_ = builder;
#line 88 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
					_tmp7_ = event;
#line 88 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 830 "test-class-signal.c"
					...
					Event _tmp10_ = {0};
					gint _tmp11_ = 0;
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
					_tmp9_ = builder;
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
					_tmp10_ = event;
#line 90 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 843 "test-class-signal.c"
				}
#line 91 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
				first = FALSE;
#line 847 "test-class-signal.c"
			}
		}
	}
#line 93 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_tmp12_ = builder;
#line 93 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	g_string_append (_tmp12_, ")) }");
#line 94 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	result = builder;
#line 94 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	return result;
...
static gint test_app_iter_cursor (TestApp* self, const gchar* kind, TrackerSparqlCursor* cursor) {
	gint result = 0;
	GError * _inner_error_ = NULL;
#line 97 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 872 "test-class-signal.c"
	{
#line 99 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		while (TRUE) {
#line 876 "test-class-signal.c"
			gboolean _tmp0_ = FALSE;
...
#line 99 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
				break;
#line 905 "test-class-signal.c"
			}
#line 100 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
			_tmp3_ = cursor;
#line 100 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 100 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
			resource = _tmp5_;
#line 102 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
			_tmp6_ = kind;
#line 102 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
			_tmp7_ = resource;
#line 102 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 106 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
			_tmp10_ = self->priv->total_signals_seen;
#line 106 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
			self->priv->total_signals_seen = _tmp10_ + 1;
#line 110 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
			_tmp11_ = self->priv->total_signals_seen;
#line 110 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
			if (_tmp11_ >= (max_signals * 2)) {
#line 933 "test-class-signal.c"
				GMainLoop* _tmp12_ = NULL;
#line 111 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
				_tmp12_ = self->priv->loop;
#line 111 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
				g_main_loop_quit (_tmp12_);
#line 939 "test-class-signal.c"
			}
#line 99 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
			_g_free0 (resource);
#line 943 "test-class-signal.c"
		}
	}
	goto __finally1;
	__catch1_g_error:
...
#line 98 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		e = _inner_error_;
#line 98 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_inner_error_ = NULL;
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_tmp13_ = e;
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_tmp14_ = _tmp13_->message;
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		g_warning ("test-class-signal.vala:115: Couldn't iterate query results: %s", _tmp14_);
#line 116 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		self->priv->res = -1;
#line 117 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		result = -1;
#line 117 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_g_error_free0 (e);
#line 117 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		return result;
#line 970 "test-class-signal.c"
	}
	__finally1:
#line 98 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	if (G_UNLIKELY (_inner_error_ != NULL)) {
...
#line 98 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		return 0;
#line 981 "test-class-signal.c"
	}
#line 119 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	result = 0;
#line 119 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	return result;
...
static void test_app_on_graph_updated_received_async_data_free (gpointer _data) {
	...
	_data_ = _data;
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 1056 "test-class-signal.c"
}


static void test_app_on_graph_updated_received_async_ready (GObject* source_object, GAsyncResult* _res_, gpointer _user_data_) {
	TestAppOnGraphUpdatedReceivedAsyncData* _data_;
#line 126 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_data_ = _user_data_;
#line 126 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
static gboolean test_app_on_graph_updated_received_async_co (TestAppOnGraphUpdatedReceivedAsyncData* _data_) {
#line 122 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	switch (_data_->_state_) {
#line 122 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		case 0:
#line 1079 "test-class-signal.c"
		goto _state_0;
#line 122 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		case 1:
#line 1083 "test-class-signal.c"
		goto _state_1;
#line 122 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		case 2:
#line 1087 "test-class-signal.c"
		goto _state_2;
		default:
#line 122 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		g_assert_not_reached ();
#line 1092 "test-class-signal.c"
	}
	_state_0:
	{
#line 126 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 127 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_data_->_tmp6_ = NULL;
#line 127 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 129 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_data_->_tmp10_ = NULL;
#line 129 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 130 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_data_->_tmp12_ = 0;
#line 130 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_data_->_tmp12_ = _data_->self->priv->res;
#line 130 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		if (_data_->_tmp12_ != (-1)) {
#line 131 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
			_data_->_tmp13_ = NULL;
#line 131 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 123 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 134 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_data_->_tmp15_ = NULL;
#line 134 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 135 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_data_->self->priv->res = -1;
#line 123 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_g_error_free0 (_data_->e);
#line 1239 "test-class-signal.c"
	}
	__finally2:
#line 123 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	if (G_UNLIKELY (_data_->_inner_error_ != NULL)) {
...
#line 123 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		return FALSE;
#line 1250 "test-class-signal.c"
	}
#line 122 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	if (_data_->_state_ == 0) {
#line 122 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		g_simple_async_result_complete_in_idle (_data_->_async_result);
#line 1256 "test-class-signal.c"
	} else {
#line 122 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		g_simple_async_result_complete (_data_->_async_result);
#line 1260 "test-class-signal.c"
	}
#line 122 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	g_object_unref (_data_->_async_result);
#line 122 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	return FALSE;
#line 1266 "test-class-signal.c"
}
...
static void test_app_on_graph_updated_received (TestApp* self, const gchar* class_name, Event* deletes, int deletes_length1, Event* inserts, int inserts_length1) {
	...
	gchar* _tmp12_ = NULL;
	gchar* _tmp13_ = NULL;
#line 139 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	g_return_if_fail (self != NULL);
#line 139 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	g_return_if_fail (class_name != NULL);
#line 140 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_tmp0_ = class_name;
#line 140 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_tmp1_ = deletes;
#line 140 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 140 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	dels_qry = _tmp6_;
#line 141 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_tmp7_ = class_name;
#line 141 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_tmp8_ = deletes;
#line 141 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 141 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	ins_qry = _tmp13_;
#line 143 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	test_app_on_graph_updated_received_async (self, dels_qry, ins_qry, NULL, NULL);
#line 139 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_g_free0 (ins_qry);
#line 139 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_g_free0 (dels_qry);
#line 1339 "test-class-signal.c"
}


static void test_app_insert_data (TestApp* self) {
	gint i = 0;
#line 146 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	g_return_if_fail (self != NULL);
#line 1347 "test-class-signal.c"
	{
		gboolean _tmp0_ = FALSE;
#line 149 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		i = 0;
#line 149 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		_tmp0_ = TRUE;
#line 149 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 149 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
				break;
#line 1383 "test-class-signal.c"
			}
#line 150 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
			_tmp3_ = i;
#line 150 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
			_tmp4_ = i;
#line 150 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 150 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
			upqry = _tmp6_;
#line 152 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 160 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	g_return_val_if_fail (self != NULL, FALSE);
#line 161 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	test_app_insert_data (self);
#line 163 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	result = FALSE;
#line 163 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	return result;
#line 1419 "test-class-signal.c"
}
...
#line 168 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	return result;
...
gint test_app_run (TestApp* self) {
	...
	gint _tmp2_ = 0;
#line 166 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	g_return_val_if_fail (self != NULL, 0);
#line 167 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 169 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_tmp1_ = self->priv->loop;
#line 169 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	g_main_loop_run (_tmp1_);
#line 170 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_tmp2_ = self->priv->res;
#line 170 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	result = _tmp2_;
#line 170 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	return result;
#line 1457 "test-class-signal.c"
}
...
#line 1517 "test-class-signal.c"
	} else {
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		value->data[0].v_pointer = NULL;
#line 1521 "test-class-signal.c"
	}
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	return NULL;
...
#line 1550 "test-class-signal.c"
	}
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	return NULL;
#line 1554 "test-class-signal.c"
}
...
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		value->data[0].v_pointer = v_object;
#line 1626 "test-class-signal.c"
	} else {
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
		value->data[0].v_pointer = NULL;
#line 1630 "test-class-signal.c"
	}
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	if (old) {
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
#line 45 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	self->priv->res = -1;
#line 47 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	self->priv->initialized = FALSE;
#line 50 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	self->priv->total_signals_seen = 0;
#line 43 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	self->ref_count = 1;
#line 1663 "test-class-signal.c"
}
...
#line 46 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_g_main_loop_unref0 (self->priv->loop);
#line 48 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_g_object_unref0 (self->priv->signal_con);
#line 49 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_g_object_unref0 (self->priv->con);
#line 1679 "test-class-signal.c"
}
...
gint _vala_main (gchar** args, int args_length1) {
	...
	TestApp* _tmp0_ = NULL;
	gint _tmp1_ = 0;
#line 175 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	_tmp0_ = test_app_new ();
#line 175 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	app = _tmp0_;
#line 177 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
...
int main (int argc, char ** argv) {
	...
	g_type_init ();
#endif
#line 174 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-class-signal.vala"
	return _vala_main (argv, argc);
#line 1749 "test-class-signal.c"
}
