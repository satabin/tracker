/* test-insert-or-replace.c generated by valac 0.35.1.15-f996c-dirty, the Vala compiler
...
#line 127 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
		if (_tmp4__length1 == 3) {
#line 76 "test-insert-or-replace.c"
			gchar** _tmp5_;
			gint _tmp5__length1;
			const gchar* _tmp6_;
			gint _tmp7_;
...
#line 131 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
			_tmp8_ = TRUE;
#line 101 "test-insert-or-replace.c"
		} else {
			gchar** _tmp10_;
...
#line 133 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
					if (!_tmp13_) {
#line 158 "test-insert-or-replace.c"
						guint _tmp14_;
#line 133 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
						_tmp14_ = i;
#line 133 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
						i = _tmp14_ + 1;
#line 164 "test-insert-or-replace.c"
					}
#line 133 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
					_tmp13_ = FALSE;
#line 133 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
...
#line 239 "test-insert-or-replace.c"
		}
...
#line 142 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
			_tmp37_ = TRUE;
#line 249 "test-insert-or-replace.c"
		} else {
			gchar** _tmp39_;
...
#line 262 "test-insert-or-replace.c"
		}
#line 142 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
		if (_tmp37_) {
#line 266 "test-insert-or-replace.c"
			GTimer* _tmp41_;
			GTimer* _tmp64_;
			guint _tmp65_;
			GTimer* _tmp66_;
...
#line 276 "test-insert-or-replace.c"
			{
				gboolean _tmp42_;
...
#line 144 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
				while (TRUE) {
#line 285 "test-insert-or-replace.c"
					guint _tmp44_;
					guint _tmp45_;
...
#line 144 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
					if (!_tmp42_) {
#line 308 "test-insert-or-replace.c"
						guint _tmp43_;
#line 144 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
						_tmp43_ = i;
#line 144 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
...
#line 144 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
						break;
#line 326 "test-insert-or-replace.c"
					}
...
#line 145 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
						_g_timer_destroy0 (timer);
#line 376 "test-insert-or-replace.c"
						goto __catch0_g_error;
					}
				}
			}
...
#line 121 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
		_g_error_free0 (e);
#line 421 "test-insert-or-replace.c"
	}
	__finally0:
#line 121 "/home/carlos/Source/gnome/tracker/tests/functional-tests/ipc/test-insert-or-replace.vala"
	if (G_UNLIKELY (_inner_error_ != NULL)) {
