/* test-shared-query.c generated by valac 0.11.4, the Vala compiler
...
static void test_app_test_query (TestApp* self) {
	...
	g_print ("\nSecond run\n");
	_tmp4_ = test_app_iter_cursor (self, cursor);
	self->priv->res = _tmp4_;
	_g_object_unref0 (cursor);
}
...
static gboolean test_app_test_query_async_co (TestAppTestQueryAsyncData* data) {
	...
	g_print ("\nSecond run\n");
	data->_tmp4_ = test_app_iter_cursor (data->self, data->cursor);
