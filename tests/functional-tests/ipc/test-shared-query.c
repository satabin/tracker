/* test-shared-query.c generated by valac 0.24.0.131-42e78, the Vala compiler
...
static gchar* test_app_type_to_string (TestApp* self, TrackerSparqlValueType type) {
	gchar* result = NULL;
	TrackerSparqlValueType _tmp0_ = 0;
	gchar* _tmp9_ = NULL;
...
#line 380 "test-shared-query.c"
					...
					TrackerSparqlCursor* _tmp26_ = NULL;
					gint _tmp27_ = 0;
...
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-shared-query.vala"
		case 0:
#line 923 "test-shared-query.c"
		goto _state_0;
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-shared-query.vala"
		case 1:
#line 927 "test-shared-query.c"
		goto _state_1;
		default:
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-shared-query.vala"
		g_assert_not_reached ();
#line 932 "test-shared-query.c"
	}
	_state_0:
#line 116 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-shared-query.vala"
	_data_->_state_ = 1;
...
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-shared-query.vala"
		g_simple_async_result_complete_in_idle (_data_->_async_result);
#line 957 "test-shared-query.c"
	} else {
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-shared-query.vala"
		g_simple_async_result_complete (_data_->_async_result);
#line 961 "test-shared-query.c"
	}
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-shared-query.vala"
	g_object_unref (_data_->_async_result);
#line 115 "/home/martyn/Source/checkout/gnome/tracker/tests/functional-tests/ipc/test-shared-query.vala"
