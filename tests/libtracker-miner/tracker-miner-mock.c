/* tracker-miner-mock.c generated by valac 0.14.0, the Vala compiler
...
TrackerMinerMock* tracker_miner_mock_construct (GType object_type, const gchar* name) {
	...
	gchar** _tmp1_ = NULL;
	gchar** _tmp2_ = NULL;
#line 37 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	g_return_val_if_fail (name != NULL, NULL);
#line 37 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	self = (TrackerMinerMock*) g_object_new (object_type, NULL);
#line 38 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	_tmp0_ = name;
#line 38 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	tracker_miner_mock_set_name (self, _tmp0_);
#line 39 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
#line 40 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
void tracker_miner_mock_set_paused (TrackerMinerMock* self, gboolean paused) {
	gboolean _tmp0_;
#line 43 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
gboolean tracker_miner_mock_get_paused (TrackerMinerMock* self) {
	...
	gboolean _tmp0_;
#line 44 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
static void _vala_array_add1 (gchar*** array, int* length, int* size, gchar* value) {
#line 51 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	if ((*length) == (*size)) {
#line 51 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 51 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
static void _vala_array_add2 (gchar*** array, int* length, int* size, gchar* value) {
#line 57 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	if ((*length) == (*size)) {
#line 57 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
		*size = (*size) ? (2 * (*size)) : 4;
#line 57 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
void tracker_miner_mock_pause (TrackerMinerMock* self, const gchar* app, const gchar* reason) {
	...
	gchar** _tmp7_;
	gint _tmp7__length1;
#line 46 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	g_return_if_fail (self != NULL);
#line 46 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	g_return_if_fail (app != NULL);
#line 46 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	g_return_if_fail (reason != NULL);
#line 48 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
#line 223 "tracker-miner-mock.c"
		...
		gchar* _tmp2_;
		gchar** _tmp3_ = NULL;
#line 49 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
		_tmp1_ = app;
#line 49 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
#line 54 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
#line 267 "tracker-miner-mock.c"
		...
		gchar* _tmp9_;
		gchar** _tmp10_ = NULL;
#line 55 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
		_tmp8_ = reason;
#line 55 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
#line 59 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	self->is_paused = TRUE;
#line 60 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
void tracker_miner_mock_resume (TrackerMinerMock* self) {
#line 63 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	g_return_if_fail (self != NULL);
#line 64 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	self->priv->_apps = (_vala_array_free (self->priv->_apps, self->priv->_apps_length1, (GDestroyNotify) g_free), NULL);
#line 64 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
#line 64 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	self->priv->__apps_size_ = self->priv->_apps_length1;
#line 65 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	self->priv->_reasons = (_vala_array_free (self->priv->_reasons, self->priv->_reasons_length1, (GDestroyNotify) g_free), NULL);
#line 65 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
#line 65 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	self->priv->__reasons_size_ = self->priv->_reasons_length1;
#line 66 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	self->is_paused = FALSE;
#line 67 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
const gchar* tracker_miner_mock_get_pause_reason (TrackerMinerMock* self) {
	const gchar* result;
	const gchar* _tmp0_;
#line 25 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
const gchar* tracker_miner_mock_get_name (TrackerMinerMock* self) {
	const gchar* result;
	const gchar* _tmp0_;
#line 26 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 26 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
gchar** tracker_miner_mock_get_apps (TrackerMinerMock* self, int* result_length1) {
	...
	gchar** _tmp1_;
	gint _tmp1__length1;
#line 27 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 27 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	_tmp0_ = self->priv->_apps;
#line 27 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
gchar** tracker_miner_mock_get_reasons (TrackerMinerMock* self, int* result_length1) {
	...
	gchar** _tmp1_;
	gint _tmp1__length1;
#line 28 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	g_return_val_if_fail (self != NULL, NULL);
#line 28 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	_tmp0_ = self->priv->_apps;
#line 28 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
#line 22 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
...
#line 26 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	_g_free0 (self->priv->_name);
#line 34 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	self->priv->_apps = (_vala_array_free (self->priv->_apps, self->priv->_apps_length1, (GDestroyNotify) g_free), NULL);
#line 35 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
	self->priv->_reasons = (_vala_array_free (self->priv->_reasons, self->priv->_reasons_length1, (GDestroyNotify) g_free), NULL);
#line 22 "/home/juerg/Code/tracker/tracker/tests/libtracker-miner/tracker-miner-mock.vala"
